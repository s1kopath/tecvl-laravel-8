...
class CouponTrigger extends Migration
{
    ...
    public function up()
    {
        // -- trigger on after insert item coupon
        \DB::unprepared('
        ...
        ');
        // -- trigger on after delete item coupon
        \DB::unprepared('
    ...
    {
        \DB::unprepared('DROP TRIGGER `item_coupons_AINS`');
        \DB::unprepared('DROP TRIGGER `item_coupons_ADEL`');
    }
}
