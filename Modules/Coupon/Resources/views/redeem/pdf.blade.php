...
@section('list-table')
    <table class="list-table">
        ...
        @foreach($redeems as $key => $redeem)
            <tr>
                <td class="text-center list-td"> {!! wrapIt($redeem->coupon->name, 10, ['columns' => 2]); !!} </td>
                <td class="text-center list-td"> {!! wrapIt($redeem->user->name, 10, ['columns' => 2]) !!} </td>
                <td class="text-center list-td"> {{ '11223344' }} </td>
