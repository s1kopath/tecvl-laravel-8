    ...
    <div class="col-sm-8 list-container">
        <div class="card">
            <div class="card-header">
                <h5><a href="#">{{ __('Edit KYC Data') }}</a></h5>
                        ...
                        <div class="btn-group" role="group">
                            <form action="{{ route('formbuilder::kyc.delete', ['id' => $submission->id]) }}" method="POST"
                                ...
                                <button type="button" class="btn btn-danger btn-sm rounded-0" data-delete="submission"
                                    data-label="{{ __('Delete') }}" data-toggle="modal" data-target="#confirmDelete"
            ...
            <div class="card-body p-0">
                <div class="card-block pt-2 px-2">
                    <div class="col-sm-12">
                        <form action="{{ route('formbuilder::kyc.sub-update', $submission->id) }}" method="POST"
