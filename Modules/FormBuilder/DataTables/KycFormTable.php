    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->addColumn('name', function ($sub) {
                ...
                $edit = '<a title="' . __('Edit :x', ['x' => __('Submission')]) . '" href="' . route('formbuilder::kyc.sub-edit', [$sub->id]) . '" class="btn btn-xs btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp';
