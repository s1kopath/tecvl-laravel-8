...
class ShopController extends Controller
{
    ...
    public function create()
    {
        ...
        $data['shop'] = PackageSubscription::where('vendor_id', $vendorId)->select('id', 'package_id')->with('package:id,params')->first()->package->params;
    ...
    public function update(Request $request, $id = null)
    {
        ...
        $request['vendor_id'] = VendorUser::getAll()->where('user_id', Auth::user()->id)->first()->vendor_id;
        $result = $this->checkExistance($id, 'shops');
