...
class BlogCategoryController extends Controller
{
    ...
    {
        $data['categoary'] = BlogCategory::get();
        return $dataTable->render('blog::category.index', $data);
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('blog.category.index')->withFaile(__('Category does not found.'));
    }
}
