...
class AdminMenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
       DB::table('admin_menus')->upsert([
        ...
        ['name' => 'Blog', 'slug' => 'blog', 'url' => 'blog/list', 'permission' => '{"permission":"Modules\\\\Blog\\\\Http\\\\Controllers\\\\BlogController@index", "route_name":["blog.index", "blog.create", "blog.edit"], "menu_level":"1"}', 'is_default' => 1]
    ], 'slug');
