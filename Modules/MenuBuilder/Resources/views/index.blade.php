...
<link rel="stylesheet" href="{{ asset('Modules/MenuBuilder/Resources/assets/css/fontawesome-iconpicker.css') }}">
@endsection
@section('content')
<!-- Main content -->
                            ...
                            <div class="wrap">
                                <div class="manage-menus">
                                    <form method="get" id="menu-from" action="{{ $currentUrl }}">
                                        <label for="menu" class="selected-menu">{{ __('Select the menu title you want to
                                            edit') }}</label>
                                        <select name="menu">
                                        ...
                                        <span class="add-new-menu-action">
                                            {{-- pleae do not remove --}}
                                            {{-- or<a href="{{ $currentUrl }}?action=edit&menu=0">{{ __('Create menu title') }}</a>. --}} 
                                        </span>
                                    </form>
                                </div>
                                                                ...
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    ...
                                                                    <p class="button-controls">
                                                                        <a href="#" {{  "onclick=addcustommenuToDb()" }}
                                                                            class="button-secondary submit-add-to-menu right">{{ __('Add menu item') }}
                                                                        </a>
                                                        ...
                                                        <div class="major-publishing-actions">
                                                            ...
                                                            <div class="publishing-action">
                                                                <a onclick="createnewmenu()" name="save_menu"
                                                                    id="save_menu_header"
                                                                    class="button button-primary menu-save">{{ __('Create Title') }}
                                                                </a>
                                                            </div>
                                                            ...
                                                            <div class="publishing-action">
                                                                <a onclick="getmenus1()" name="save_menu"
                                                                    id="save_menu_header"
                                                                    class="button button-primary menu-save">{{ __('Save menu') }}
                                                                </a>
                                                            </div>
                                                            @else
                                                            <div class="publishing-action">
                                                    ...
                                                    <div id="post-body">
                                                        <div id="post-body-content">
                                                            ...
                                                            <div class="drag-instructions post-body-plain" style="">
                                                                <p>
                                                                    {{ __('Place each item in the order you prefer. Click on
                                                                ...
                                                                <li id="menu-item-{{$m->id}}"
                                                                    ...
                                                                    <div class="menu-item-settings"
                                                                        ...
                                                                        <p class="field-css-classes description description-thin">
                                                                            <label for="edit-menu-item-icon-{{ $m->id }}">
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    class="form-control icp icp-auto iconpicker-component iconpicker-input edit-menu-item-icon"
                                                                                    name="icon_menu_{{ $m->id }}"
                                                                                    value="{{ $m->icon }}" readonly>
                                                                            </label>
                                                                        </p>
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <label> <span>{{ __('Move') }}</span>
                                                                                 <a href="{{ $currentUrl }}"
                                                                                    class="menus-move-up"
                                                                                    style="display: none;">{{ __('Move up') }}
                                                                                 </a> ||
                                                                                <a href="{{ $currentUrl }}"
                                                                                    class="menus-move-down"
                                                                                    title="Mover uno abajo"
                                                                                    style="display: inline;">{{ __('Move Down') }}</a> <a href="{{ $currentUrl }}" 
                                                                                    style="display: none;">
                                                                                </a> 
                                                                                <a
                                                                                    href="{{ $currentUrl }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a onclick="deleteitem(this)"
                                                                                class="item-delete submitdelete deletion delete-{{ $m->id }}"
                                                    ...
                                                    <div id="nav-menu-footer">
                                                        <div class="major-publishing-actions">
                                                            ...
                                                            <div class="publishing-action">
                                                                <a onclick="createnewmenu()" name="save_menu"
                                                                    id="save_menu_header"
                                                                    class="button button-primary menu-save">{{ __('Create menu') }}
                                                                </a>
                                                            </div>
                                                            @elseif(request()->has("menu"))
                                                            <span class="delete-action">
                                                                <a
                                                                    ...
                                                                    onclick="deletemenu()"
                                                                    href="javascript:void(9)">{{ __('Delete menu') }}
                                                                </a>
                                                            </span>
                                                            <div class="publishing-action">
                                                                <a onclick="getmenus1()" name="save_menu"
