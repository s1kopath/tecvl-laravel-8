...
@section('content')
    <div class="col-sm-12 list-container" id="vendor-refund-edit-container">
        <div class="card">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <div class="col-7 border p-3">
                                    <form action="{{ route('vendor.refund.update', ['id' => $refund->id]) }}" method="post" class="form-horizontal" id="delete-refund-{{ $refund->id }}">
                                        @csrf
