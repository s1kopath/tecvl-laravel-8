...
@section('content')
    <div class="dark:bg-red-1 h-full xl:pl-74p lg:px-74p px-2 pt-30p lg:pt-14 bg-white">
        <div>
            ...
            <p
                class="dark:text-gray-2 lg:mt-1.5 roboto-medium font-medium text-base lg:text-xl mt-4 text-20 text-gray-10 leading-6">
                {{ __('We got you covered about your concern..') }}</p>
        </div>
        <div class="lg:mt-74p mt-10 mb-5 xl:w-2/3 3xl:w-1/2 w-full flex justify-between">
            <p class="dm-bold font-bold text-gray-12 lg:text-2xl text-lg uppercase">{{ __('Requesting refund') }}</p>
        ...
        <div  class="xl:w-2/3 3xl:w-1/2 w-full border border-gray-2 rounded">
            ...
            <form action="{{ route('site.orderRefund') }}" method="POST" enctype="multipart/form-data"  class="lg:mt-60p mt-9 3xl:px-40 2xl:px-32 xl:px-24 lg:px-20  sm:px-20  md:px-5 px-5" >
                ...
                <section class="sm:mr-4 md:mr-0 styled-select flex flex-col lg:mr-4 mr-0 ">
                    ...
                    <select name="order_reference"
                        class="w-full form-control h-46p border-gray-2 cursor-pointer appearance-none  sl_common_bx"
                ...
                <section class="sm:mr-4 md:mr-0 styled-select flex mt-15p flex-col lg:mr-4 mr-0">
                    ...
                    <select id="order_items" name="order_items"
                        class="form-control  w-full h-46p border-gray-2 cursor-pointer appearance-none  sl_common_bx"
                        required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        <option value="">{{ __('Select one') }}</option>
                    </select>
                </section>
                <section class="sm:mr-4 md:mr-0 styled-select flex flex-col mt-15p lg:mr-4 mr-0 ">
                ...
                <section class="sm:mr-4 md:mr-0 styled-select flex flex-col mt-15p lg:mr-4 mr-0 ">
                    ...
                    <select name="refund_reason_id"
                        class="form-control border-gray-2 cursor-pointer appearance-none w-full sl_common_bx" required
                ...
                <div class="refund-image  w-full">
                    <div id="refund_image" class="inline-flex flex-wrap">
                    </div>
                </div>
                <div class="flex lg:mt-4 mt-18p w-full">
                    ...
                    <div class="lg:mt-3.5 mt-1 ml-4">
                        <p
                            class="dm-sans font-medium require-profile lg:text-sm text-13 text-gray-12 whitespace-nowrap lg:mb-3 mb-2">
                            {{ __('Upload Images of the Product') }}
                        </p>
                        <div class="roboto-medium font-medium lg:text-xs text-xss text-gray-10">
                            <p>{{ __('You should upload minimum 2 images.') }}</p>
                            {{ __('One of the product and another of the receipt papers.') }}
                        </div>
                    </div>

                </div>
                <label class="text-red-500" id="image_error" for=""></label>
