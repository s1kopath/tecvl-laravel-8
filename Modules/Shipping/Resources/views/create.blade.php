...
@section('page_title', __('Create Shipping'))
@section('css')
...
@section('content')
    <div class="col-sm-12" id="shipping-add-container">
        <div class="card">
            <div class="card-header">
                <h5><a href="{{ route('shipping.index') }}">{{ __('Shippings') }}</a> >> {{ __('Add Shipping') }}</h5>
            </div>
                ...
                <div class="form-tabs">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form action="{{ route('shipping.store') }}" method="post" class="form-horizontal">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" step="any" max="99999999" placeholder="{{ __('Cost') }}" class="form-control remove-dash" id="price" name="cost" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-max="{{ __('The value must be :x than or equal to :y.', ['x' => __('less'), 'y' => 99999999]) }}" value="{{ old('cost') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" step="any" placeholder="{{ __('Minimum Amount') }}" class="form-control remove-dash" id="minimum_amount" name="minimum_amount" data-max="{{ __('The value must be :x than or equal to :y.', ['x' => __('less'), 'y' => 99999999]) }}" value="{{ old('minimum_amount') }}">
                                    </div>
                                </div>
