    ...
    <div class="dark:bg-red-1 h-full xl:px-74p px-5 pt-30p xl:pt-14">
                        ...
                        <div x-data="{ dropdownOpen: false }">
                            <div class="flex items-center ml-3">
                                <button @click="dropdownOpen = !dropdownOpen" class="inline-flex justify-between lg:w-168p w-24 rounded-sm border border-gray-2 px-2 lg:py-2.5 py-1 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none dark:bg-gray-2">
                                    <div class="roboto-medium font-medium text-gray-10 lg:text-base text-xss whitespace-nowrap  dark:text-gray-2"> <span>All</span>
                                    </div>
                                    <span class="mt-2 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="7" viewBox="0 0 13 7" fill="none">
        ...
        <div class="lg:mt-30p mt-15p lg:mb-30p mb-6">
            <div class=" cursor-pointer transition delay-150 bg-white hover:bg-gray-11 border border-gray-2 rounded lg:px-30p px-3 lg:flex items-center justify-between">
                <div class="flex ">
                    ...
                    <p class="roboto-medium font-medium lg:text-base text-11 lg:py-10 py-4 lg:ml-5 ml-2.5 text-gray-10 hover:text-gray-12 ">
                        GREAT NEWS! We are really excited to announce that our app version of multi-vendor will be launched on 1 Feb, 2022. Stay tuned.</p>
                </div>
                <p  class="roboto-medium font-medium  lg:text-sm text-xss text-gray-10 -mt-3 lg:mt-0 lg:text-right text-left ml-38p lg:mb-0 mb-3.5"> 2 hours ago</p>
            </div>
            <div class=" lg:mt-15p mt-2 cursor-pointer transition delay-150 text-gray-10 hover:text-gray-12  bg-white hover:bg-gray-11 border border-gray-2 rounded lg:px-30p px-3 lg:flex items-center justify-between ">
                <div class="flex">
                    <img class="lg:h-10 h-7 lg:w-10 w-7 lg:my-30p my-4" src="{{ asset('public/frontend/assets/img/notification/Group 601.png') }}" alt="" />
                    <p class="roboto-medium font-medium lg:text-base text-11 lg:py-10 py-4 lg:ml-5 ml-2.5 text-gray-10 hover:text-gray-12 "> NEW UPDATE! Bookie’s Cookie House has opened their shop here and offering 50% discount for first 100 customers. What are you waiting  for? Click here to visit.</p>
                </div>
                <p class="roboto-medium font-medium  lg:text-sm text-xss -mt-3 lg:mt-0 text-gray-10  lg:text-right text-left ml-38p lg:mb-0 mb-3.5"> 2 hours ago</p>
            </div>
            <div class="mt-15p cursor-pointer transition delay-150 text-gray-10 hover:text-gray-12  bg-white hover:bg-gray-11 border border-gray-2 rounded lg:px-30p px-3 lg:flex items-center justify-between">
                <div class="flex">
                    <img class="lg:h-10 h-7 lg:w-10 w-7 lg:my-30p my-4" src="{{ asset('public/frontend/assets/img/notification/Group 606.png') }}" alt="" />
                    <p class="roboto-medium font-medium lg:text-base text-11 lg:py-10 py-4 lg:ml-5 ml-2.5 text-gray-10 hover:text-gray-12 "> Gamik Wireless Gaming Headphone is now available in stock. Hurry up now!</p>
                </div>
            ...
            <div class="mt-15p cursor-pointer transition delay-150 text-gray-10 hover:text-gray-12  bg-white hover:bg-gray-11 border border-gray-2 rounded lg:px-30p px-3 lg:flex items-center justify-between">
                <div class="flex">
                    <img class="lg:h-10 h-7 lg:w-10 w-7 lg:my-30p my-4" src="{{ asset('public/frontend/assets/img/notification/unsplash_9xnnEpX6HAA.png') }}" alt="" />
                    <p class="roboto-medium font-medium lg:text-base text-11 lg:py-10 py-4 lg:ml-5 ml-2.5 text-gray-10 hover:text-gray-12">Kyle Harass Furnitures has replied to your message. Give a response.</p>
                </div>
            ...
            <div class="mt-15p cursor-pointer transition delay-150 text-gray-10 hover:text-gray-12  bg-white hover:bg-gray-11 border border-gray-2 rounded lg:px-30p px-3 lg:flex items-center justify-between">
                <div class="flex">
                    ...
                    <p class="roboto-medium font-medium lg:text-base text-11 lg:py-10 py-4 lg:ml-5 ml-2.5 text-gray-10 hover:text-gray-12">Zen V Polo T-Shirt has been added to your wishlist.</p>
                </div>
            ...
            <div class=" mt-15p cursor-pointer transition delay-150 text-gray-10 hover:text-gray-12  bg-white hover:bg-gray-11 border border-gray-2 rounded lg:px-30p px-3 lg:flex items-center justify-between">
                <div class="flex">
                    ...
                    <p class="roboto-medium font-medium lg:text-base text-11 lg:py-10 py-4 lg:ml-5 ml-2.5 text-gray-10 hover:text-gray-12">Your password has been successfully changed.</p>
                </div>
        ...
        <div class="flex lg:justify-between justify-center">
            <div class="lg:block hidden">
                <a class="roboto-medium text-left font-medium text-base mt-30p  text-gray-10">Showing 
            ...
            <a class="flex cursor-pointer  lg:justify-between justify-center">
                <span class="dm-sans  font-medium lg:text-base text-xs text-gray-12">See More</span>
