...
@section('content')
            ...
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-white md:border-2 border border-gray-12 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-12 md:text-base text-8">1</span>
                    </div>

                    <div class="md:p-4 p-1">
                        <svg class="hidden md:block" xmlns="http://www.w3.org/2000/svg" width="183" height="6" viewBox="0 0 183 6" fill="none">
                            <path
                        ...
                        <svg class="md:hidden" width="63" height="5" viewBox="0 0 63 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="absolute -left-1.5 md:-left-5 mt-2.5 md:mt-5 whitespace-nowrap dm-bold font-bold text-gray-12 text-8 md:text-base">{{ __('My Cart') }}</p>
            </div>
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-gray-11 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-10 md:text-base text-8">2</span>
                    </div>
                    <div class="md:p-4 p-1">
                        <svg class="hidden md:block" xmlns="http://www.w3.org/2000/svg" width="183" height="6" viewBox="0 0 183 6" fill="none">
                            <path
                ...
                <p class="absolute -left-2.5 md:-left-4 mt-2.5 md:mt-5 whitespace-nowrap dm-bold font-bold text-gray-10 text-8 md:text-base">{{ __('Checkout') }}</p>
            </div>
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-gray-11 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-10 md:text-base text-8">3</span>
                    </div>
                    <div class="md:p-4 p-1">
                        <svg class="hidden md:block" xmlns="http://www.w3.org/2000/svg" width="183" height="6" viewBox="0 0 183 6" fill="none">
                            <path
                ...
                <p class="absolute -left-2.5 md:-left-4 mt-2.5 md:mt-5 whitespace-nowrap dm-bold font-bold text-gray-10 text-8 md:text-base">{{ __('Payment') }}</p>
            </div>
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-gray-11 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-10 text-8 md:text-base ">4</span>
                    </div>
                </div>
                <p class="absolute -left-7 md:-left-14 mt-2.5 md:mt-5 whitespace-nowrap dm-bold font-bold text-gray-10 text-8 md:text-base">{{ __('Order complete') }}</p>
            </div>
        </div>
    </section>
    ...
    <section class="text-gray-600 body-font relative mx-4 lg:mx-4 xl:mx-32 2xl:mx-64 3xl:mx-92 mt-11 md:mt-80p" id="cart-details-container">
        <div class="md:flex sm:flex-nowrap flex-wrap md:pt-8">
                ...
                <div class="bg-white dark:bg-gray-2 rounded shadow w-full md:pr-6">
                    ...
                    <div id="cart-items">
                       ...
                       @if(count($carts) > 0)
                        ...
                        <div class="border my-5 rounded vendor-parent mx-1.5 md:mx-0">
                            ...
                            <div class=" vendor-area rounded-t px-5 py-3 flex items-center justify-between shop-box bg-gray-11">
                                <label class="flex items-center c-check">
                                    <input type="checkbox" class="form-checkbox cart-shop" data-shop_id="{{ $cartData[0]['shop_id'] }}" data-vendor_id="{{ $cartData[0]['vendor_id'] ?? null }}" {{ \App\Models\Item::isShopSelected($cartData[0]['shop_id']) ? 'disabled' : '' }}>
                                    <span class="ml-3 text-sm dm-sans font-medium text-gray-12">{{ $shops[$cartData[0]['shop_id']] }}</span>
                                </label>
                                <p class="text-xs text-gray-12 dm-sans">
                                    Estimate Time: 12 Dec
                                </p>
                            </div>
                             @else
                            <div class="p-3 mt-5 flex items-center justify-between shop-box">
                                <input type="checkbox" class="form-checkbox hide-checkbox cart-shop" data-shop_id="0">
                            </div>
                            @endif
                            <div class="vendor-block">
                                @foreach($cartData as $cart)
                                <div class="rounded-t-none w-full rounded px-2.5 md:px-5 items-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 cart-item-header pb-15p md:pb-0" id="cart-item-{{$cart['index']}}">
                                    <div class="col-span-1 md:col-span-2 grid grid-cols-3 md:grid-cols-3 pb-2 md:pb-4 items-center">
                                        <div class="c-check mt-4">
                                            <div class="flex items-center check-bg">
                                                <input type="checkbox" name="items[]" {{ in_array($cart['index'], $selectedCarts) && $cart['availability'] == 1 && $cart['inventoryEnable'] == true ? 'checked' : '' }} {{ $cart['availability'] == 0 || $cart['inventoryEnable'] == false ? 'disabled' : '' }} value="{{ $cart['index'] }}" class="form-checkbox cart-item-single cart-shop-{{ $cart['shop_id'] != null ? $cart['shop_id'] : 0 }}" data-price="{{ $cart['price'] }}" data-quantity="{{ $cart['quantity'] }}" data-shop_id="{{ $cart['shop_id'] != null ? $cart['shop_id'] : 0 }}" data-index="{{ $cart['index'] }}" data-tax = "{{ $cart['tax_rate'] }}" data-shipping = "{{ $cart['shipping'] }}">
                                                <div class="flex items-center sm:w-24 sm:h-24 w-68p h-68p md:w-20 md:h-20 md:m-3 border ml-2 md:ml-3 rounded">
                                                    <img class="w-full h-full object-contain" src="{{ $cart['photo'] }}" class="w-full p-2">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-span-2 mt-4">
                                            <div class="x:pl-4 xs:pl-0 xxs:-ml-19% xxs:pl-6 sm:-ml-19% pl-4 md:ml-0 md:pl-8 md:mt-2 lg:pl-5 xl:pl-6 2xl:pl-2">
                                                <h3 class="text-xs md:text-15 dm-sans font-medium text-gray-12 leading-5"><a href="{{ route('site.itemDetails', ['code' => $cart['item_code'], 'name' => cleanedUrl($cart['name'])]) }}">{{ $cart['name'] }}</a></h3>
                                                <div class="md:-mt-0 -mt-1.5">
                                                    @php
                                                        $optionNames = json_decode($cart['option_name']);
                                                        $options = json_decode($cart['option']);
                                                        $commaCount = 0;
                                                    @endphp
                                                    @if($optionNames != null && count($optionNames) > 0)
                                                        @foreach($optionNames as $opKey => $name)
                                                            @php $commaCount++ @endphp
                                                            @if ($loop->iteration == 1)
                                                            <span class="text-gray-10 text-xss md:text-xs roboto-medium {{ $loop->last ? " " : "border-r" }} pr-1">
                                                                {{ $name ." : ". $options[$opKey] }} {{ count($optionNames) < $commaCount ? "," : '' }}
                                                            </span>
                                                            @else
                                                            <span class="text-gray-10 text-xss md:text-xs roboto-medium {{ $loop->last ? " " : "border-r" }} pr-1 pl-1.5">
                                                                {{ $name ." : ". $options[$opKey] }} {{ count($optionNames) < $commaCount ? "," : '' }}
                                                            </span>
                                                            @endif
                                                ...
                                                <h4 class="text-sm font-medium dm-sans text-gray-12">
                                                    <span></span><span class="cart-item-price">{{ formatNumber($cart['price']) }}</span>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="w-full flex justify-between items-center md:justify-center md:mt-4">
                                        <div class="flex flex-wrap pl-6 ml-28% xxs:pl-2.5 xxs:ml-23% sm:pl-0 sm:ml-23% md:ml-0 md:pl-0 justify-start space-x-5">
                                            <div class="flex flex-wrap text-xl border rounded md:mb-2.5 md:-ml-19% lg:ml-0 lg:mb-0">
                                                <a href="javascript:void(0)" class="flex items-center justify-center cart-page-item-qty-dec m-auto text-2xl font-thin text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-7 md:h-9 w-8 rounded-l cursor-pointer outline-none text-center" data-itemId = "{{ $cart['id'] }}" data-index = "{{ $cart['index'] }}" data-price = "{{ $cart['price'] }}">
                                                    <span class="inline-block">
                                                        <svg class="" width="9" height="2" viewBox="0 0 9 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M9 1.2H0L0 0H9V1.2Z" fill="#2C2C2C"/>
                                                        </svg>
                                                    </span>
                                                </a>

                                                <div class="h-7 md:h-9 w-9 cart-item-quantity flex items-center justify-center">
                                                    <p class="dm-sans font-medium text-sm text-gray-12">{{ $cart['quantity'] }}</p>
                                                </div>

                                                <a href="javascript:void(0)" class="flex items-center justify-center cart-page-item-qty-inc text-2xl font-thin text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-7 md:h-9 w-8 rounded-r cursor-pointer" data-itemId = "{{ $cart['id'] }}" data-index = "{{ $cart['index'] }}" data-price = "{{ $cart['price'] }}">
                                                    <span class="inline-block">
                                                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5.2 -5.24537e-08L5.2 9.2L4 9.2L4 0L5.2 -5.24537e-08Z" fill="#2C2C2C"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M9.19922 5.2L-0.000782065 5.2L-0.000782013 4L9.19922 4L9.19922 5.2Z" fill="#2C2C2C"/>
                                                        </svg>
                                                    </span>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="md:hidden text-gray-12 px-1 delete-cart-item" data-index="{{ $cart['index'] }}">
                                            <svg width="14" height="15" viewBox="0 0 11 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.27713 8.55566C3.93962 8.55566 3.66602 8.28206 3.66602 7.94455L3.66602 6.11122C3.66602 5.77371 3.93962 5.50011 4.27713 5.50011C4.61463 5.50011 4.88824 5.77371 4.88824 6.11122L4.88824 7.94455C4.88824 8.28206 4.61463 8.55566 4.27713 8.55566Z" fill="#898989"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.72244 8.55566C6.38493 8.55566 6.11133 8.28206 6.11133 7.94455L6.11133 6.11122C6.11133 5.77371 6.38493 5.50011 6.72244 5.50011C7.05995 5.50011 7.33355 5.77371 7.33355 6.11122L7.33355 7.94455C7.33355 8.28206 7.05995 8.55566 6.72244 8.55566Z" fill="#898989"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.627147 3.67775C0.482326 3.66787 0.293103 3.66754 0 3.66754V2.44531C0.00653662 2.44531 0.0130517 2.44531 0.0195452 2.44531C0.0326672 2.44531 0.0457011 2.44531 0.0586465 2.44531H10.9414C10.9543 2.44531 10.9673 2.44531 10.9805 2.44531L11 2.44531V3.66754C10.7069 3.66754 10.5177 3.66787 10.3729 3.67775C10.2335 3.68725 10.1805 3.70352 10.155 3.71405C10.0053 3.77608 9.88632 3.89505 9.8243 4.04478C9.81376 4.07022 9.7975 4.12328 9.78799 4.26261C9.77811 4.40743 9.77778 4.59665 9.77778 4.88976L9.77778 8.59664C9.77781 9.13839 9.77784 9.60517 9.72758 9.97896C9.67372 10.3796 9.55227 10.7635 9.24081 11.075C8.92935 11.3865 8.54535 11.5079 8.14476 11.5618C7.77097 11.612 7.30419 11.612 6.76245 11.612H4.23755C3.6958 11.612 3.22903 11.612 2.85524 11.5618C2.45465 11.5079 2.07065 11.3865 1.75919 11.075C1.44773 10.7635 1.32628 10.3796 1.27242 9.97896C1.22216 9.60517 1.22219 9.1384 1.22222 8.59665L1.22222 4.88976C1.22222 4.59665 1.22189 4.40743 1.21201 4.26261C1.2025 4.12328 1.18624 4.07022 1.1757 4.04478C1.11368 3.89505 0.994713 3.77608 0.844973 3.71405C0.819543 3.70352 0.766479 3.68725 0.627147 3.67775ZM8.66116 3.66754H2.33884C2.39616 3.83718 2.41972 4.00832 2.4314 4.17941C2.44446 4.37085 2.44445 4.60215 2.44445 4.87021L2.44444 8.55642C2.44444 9.14986 2.44574 9.53346 2.48374 9.81611C2.51938 10.0812 2.57691 10.1642 2.62343 10.2108C2.66996 10.2573 2.75303 10.3148 3.0181 10.3505C3.30074 10.3885 3.68434 10.3898 4.27778 10.3898H6.72222C7.31566 10.3898 7.69926 10.3885 7.9819 10.3505C8.24697 10.3148 8.33004 10.2573 8.37657 10.2108C8.42309 10.1642 8.48062 10.0812 8.51626 9.81611C8.55426 9.53346 8.55556 9.14986 8.55556 8.55642V4.87021C8.55555 4.60215 8.55554 4.37085 8.5686 4.17941C8.58028 4.00832 8.60384 3.83718 8.66116 3.66754Z" fill="#898989"/>
                                    ...
                                    <div class="pl-8">
                                        <div class="md:flex md:items-center lg:flex-col items-center md:-ml-14 lg:ml-0">
                                            @php
                                                $active = false;
                                                if (auth()->user()) {
                                                    foreach (auth()->user()->wishlist as $key => $wishlist) {
                                                        if ($cart['id'] == $wishlist->item_id) {
                                                            $active = true;
                                                        }
                                                    }
                                                }
                                            ...
                                            <div class="md:flex md:pb-0 lg:pb-2 hidden whitespace-nowrap">
                                                <div class="flex items-center cursor-pointer text-transparent mt-1 wishlist md:pr-4 lg:pr-0 md:border-r lg:border-none" data-id="{{ $cart['id'] }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" class="{{ $active ? 'color_fill svg-bg ' : 'text-gray-10'  }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                                                    </svg>
                                                    <p class="roboto-medium text-xs text-gray-10 pl-1">
                                                        {{ __('Save for later') }}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="md:flex md:border-t-0 lg:border-t md:pt-0 lg:pt-2 md:ml-4 hidden whitespace-nowrap">
                                                <button class="flex text-gray-12 px-1 delete-cart-item md:mt-0 lg:mt-1" data-index="{{ $cart['index'] }}">
                        ...
                        @endforeach
                        @else
                            <h3 class="text-xl mt-4 font-bold dark:text-gray-2 text-center" class="cart-empty">{{ __('Empty!') }}
                            </h3>
                        @endif

                    </div>
                    <div class="">
                        <a href="{{ route("site.index") }}" class="flex relative mt-30p arrow-hover font-medium dm-sans text-gray-10 text-base pl-4">
            ...
            <div class="md:w-42% lg:w-1/3 flex flex-col md:ml-auto w-full mb-10">
                <div class="flex justify-between flex-wrap lg:justify-center">
                    <div class="rounded bg-white dark:bg-gray-2 w-full border">
                        <div class="w-full bg-orange-200 px-5 py-5 text-gray-12 font-medium dm-sans">
                            ...
                            <div class="flex justify-between mt-3 text-sm border-b pb-3">
                                ...
                                <div class='text-right'><span id="cart-subtotal">0</span>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-between mt-3">
                                <div class="text-sm">
                                    {{ __('Shipping') }}</div>
                                <div class='text-sm text-right'><span id="shipping">0</span>
                                </div>
                            </div>
                            @endif
                            @php $couponOffer = 0; @endphp
                            @if(isset($coupon) && !empty($coupon))
                              @php  $couponOffer = $coupon['calculated_discount']; @endphp
                            @endif
                            <input type="hidden" value="{{ $coupon['discount_type'] ?? null }}" id="couponDiscountType">
                            <input type="hidden" value="{{ $coupon['discount_amount'] ?? null }}" id="couponDiscountAmount">
                            @if(isActive('Coupon'))
                            <div class="flex justify-between mt-3">
                                <div class="text-sm">
                                    {{ __('Coupon offer') }}
                                </div>
                                <div class='text-sm text-right'><span id="couponOffer">{{ formatCurrencyAmount($couponOffer) }}</span></div>
                            </div>
                            @endif

                            <div class="flex justify-between mt-3">
                                <div class="text-sm">{{ __('Tax') }}</div>
                                <div class='text-sm text-right'><span id="tax">0</span>
                                </div>
                            </div>
                            <div class="flex justify-between mt-3 border-t">
                                ...
                                <div class="text-base mt-2">
                                    <span id="cart-total">{{ formatCurrencyAmount($totalPrice - $couponOffer) }}</span></div>
                            </div>
                            @if(isActive('Coupon'))
                            <div class="mt-10">
                                <p class="font-hkbold text-secondary text-sm">{{ __('Have a coupon? Apply Now.') }}</p>
                                <div class="flex justify-between mt-13p border hover:border-green-500 rounded color_switch_borders">
                                    <input type="text" placeholder="Type Coupon Code" class="w-3/5 xl:w-2/3 focus:outline-none rounded form-input rtl-direction-space text-sm roboto-regular" id="discount_code">
                                    <div class="py-2 rounded pr-1.5"
                                            aria-label="Apply button" id="checkCoupon">
                                            <a href="javascript:void(0)" class="text-white hover:text-yellow-1">
                                                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="0.5" y="0.5" width="33" height="33" rx="1.5" fill="currentColor" stroke="#DFDFDF"/>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M19.0813 13L17.9039 14.2018L19.8128 16.1502H11.8325C11.3727 16.1502 11 16.5307 11 17C11 17.4693 11.3727 17.8498 11.8325 17.8498H19.8128L17.9039 19.7982L19.0813 21L23 17L19.0813 13Z" fill="#2C2C2C"/>
                                                </svg>
                                            </a>
                                    </div>
                                </div>
                            ...
                            @endif
                            <a href="javascript:void(0)" class="checkOut process-hover relative flex justify-center items-center text-center px-4 py-4 text-sm md:text-base text-white w-full mt-5 rounded dm-bold font-bold hover:bg-yellow-1 hover:text-gray-12 bg-black">
                            ...
                            <div class="">
                                ...
                                <div class="flex justify-center space-x-4 mt-5 mb-5">
                                    <div class="w-10 h-3">
                                        <img src="{{ asset('public/frontend/assets/img/payment/visa2.png') }}" alt="" class="w-100 h-100">
                                    </div>
                                    <div class="w-10 h-3">
                                        <img src="{{ asset('public/frontend/assets/img/payment/mastercard1.png') }}" alt="" class="w-100 h-100 -mt-2">
                                    </div>

                                    <div class="w-14 h-3">
                                        <img src="{{ asset('public/frontend/assets/img/payment/paypal1.png') }}" alt="" class="w-100 h-100">
                                    </div>
                                    <div class="w-14 h-3">
                                        <img src="{{ asset('public/frontend/assets/img/payment/paypass1.png') }}" alt="" class="w-100 h-100">
                                    </div>
                                    <div class="w-14 h-3">
                                        <img src="{{ asset('public/frontend/assets/img/payment/paykeeper1.png') }}" alt="" class="w-100 h-100">
                                    </div>
                                    <div class="w-14 h-3">
                                        <img src="{{ asset('public/frontend/assets/img/payment/westerunio.png') }}" alt="" class="w-100 h-100">
                                    </div>
                                </div>
                            </div>
                        </div>
