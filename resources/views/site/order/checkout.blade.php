...
@section('content')
    <section class="mx-4 lg:mx-4 xl:mx-32 2xl:mx-64 3xl:mx-92 mt-70p mb-20">
        <div class="flex justify-center items-center mt-5 -ml-5 md:-ml-0">
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-white md:border-2 border border-gray-12 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-12 md:text-base text-8">{{ __('1') }}</span>
                    </div>
                    ...
                    <div class="md:p-4 p-1">
                        <svg class="hidden md:block" xmlns="http://www.w3.org/2000/svg" width="183" height="6" viewBox="0 0 183 6" fill="none">
                            <path d="M182.887 3.00002L180 0.113264L177.113 3.00002L180 5.88677L182.887 3.00002ZM-4.37114e-08 3.5L180 3.50002L180 2.50002L4.37114e-08 2.5L-4.37114e-08 3.5Z" fill="#33C172"></path>
                        </svg>
                        <svg class="md:hidden" width="63" height="5" viewBox="0 0 63 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M62.8867 3.00001L60 0.113254L57.1132 3L60 5.88676L62.8867 3.00001ZM-4.37114e-08 3.5L60 3.50001L60 2.50001L4.37114e-08 2.5L-4.37114e-08 3.5Z" fill="#33C172"></path>
                        </svg>
                    </div>
                </div>
            ...
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-gray-11 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-10 md:text-base text-8">{{ __('2') }}</span>
                    </div>
                    <div class="md:p-4 p-1">
                        <svg class="hidden md:block" xmlns="http://www.w3.org/2000/svg" width="183" height="6" viewBox="0 0 183 6" fill="none">
                            <path d="M182.887 3.00002L180 0.113264L177.113 3.00002L180 5.88677L182.887 3.00002ZM-4.37114e-08 3.5L180 3.50002L180 2.50002L4.37114e-08 2.5L-4.37114e-08 3.5Z" fill="#DFDFDF"></path>
                        </svg>
                        <svg class="md:hidden" width="63" height="5" viewBox="0 0 63 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M62.8867 3.00001L60 0.113254L57.1132 3L60 5.88676L62.8867 3.00001ZM-4.37114e-08 3.5L60 3.50001L60 2.50001L4.37114e-08 2.5L-4.37114e-08 3.5Z" fill="#DFDFDF"></path>
                        </svg>
                    </div>
                </div>
            ...
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-gray-11 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-10 md:text-base text-8">{{ __('3') }}</span>
                    </div>
                    <div class="md:p-4 p-1">
                        <svg class="hidden md:block" xmlns="http://www.w3.org/2000/svg" width="183" height="6" viewBox="0 0 183 6" fill="none">
                            <path d="M182.887 3.00002L180 0.113264L177.113 3.00002L180 5.88677L182.887 3.00002ZM-4.37114e-08 3.5L180 3.50002L180 2.50002L4.37114e-08 2.5L-4.37114e-08 3.5Z" fill="#DFDFDF"></path>
            ...
            <div class="uppercase relative">
                <div class="flex justify-center items-center">
                    <div class="md:h-9 md:w-9 h-5 w-5 bg-gray-11 rounded-full flex justify-center items-center">
                        <span class="dm-bold font-bold text-gray-10 text-8 md:text-base ">{{ __('4') }}</span>
                    </div>
                </div>
    ...
    <section class="text-gray-600 body-font relative mx-4 lg:mx-4 xl:mx-32 2xl:mx-64 3xl:mx-92 mt-80p" id="order-checkout-container">
        <form action="{{ route('site.orderStore') }}" method="POST" id="addressForm">
            ...
            <div class="flex md:flex-nowrap flex-wrap pt-8">
                <div class="md:w-2/3 overflow-hidden flex justify-start relative mb-10 rtl-direction-space-left-cart">
                    <div class="flex flex-wrap w-full pr-7">
                        ...
                        <div id="tabs" class="p_tabs w-full mt-4 address-tab">
                                            ...
                                            <div>
                                                <div class="flex justify-between items-center border-b border-gray-2 pb-4">
                                                    <div class="radio-container-payment">
                                                        <input class="address-radio" type="radio" id="new-address{{ $key }}" name="new_address" {{ $address->is_default == 1 ? 'checked' : '' }} data-addressId = "{{ $address->id }}"/>
                                                        <label class="ab-label dm-sans font-medium text-gray-10 text-base" for="new-address{{ $key }}">{{ __('Address')."-".$key }} ({{ ucfirst($address->type_of_place) }})</label>
                                                    </div>
                                                ...
                                                <div class="mt-4">
                                                    <h3 class="mb-4 ab-name dm-sans text-gray-10 text-sm font-bold uppercase">{{ $address->first_name }} {{ $address->last_name }}</h3>
                                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-24">
                                                        <div class="flex flex-col break-all">
                                                            <div class="flex items-start mb-1">
                                                                <span class="mr-2.5">
                                                                    <svg class="mt-2" xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                        ...
                                                        <div class="col-span-2 break-all">
                                                            <div class="flex">
                                                                <span class="mr-2.5">
                                                                    <svg  class="mt-2" xmlns="http://www.w3.org/2000/svg" width="11" height="13" viewBox="0 0 11 13" fill="none">
                                                                        ...
                                                                        <span class="mt-0.5">{{ $address->address_1 }} {{ $address->address_2 }}.
                                                                    <br>
                                                                    {{ __('City') }}: {{ $address->city }}, {{ __('State') }}: {{ $address->state }}, {{ __('ZIP') }}/{{ __('Postcode') }}: {{ $address->zip }}, {{ __('Country') }}: {{  $address->country }}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="c-tab {{ count($addresses) == 0 ? 'is-active' : '' }} mt-5 form-tab">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 address-form">
                                    ...
                                    <div>
                                        <label class="dm-sans font-medium text-gray-12 text-sm" for="last_name">{{ __('Last Name') }} <span>*</span></label>
                                        <input id="last_name" name="last_name"  type="text" class="block w-full py-2 mt-2 text-gray-700 bg-white border border-gray-2 rounded-sm dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2  focus:border-gray-12 dark:focus:border-purple-500 focus:outline-none form-control required-field"
                                               required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" maxlength="191" value="{{ old('last_name') }}">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 gap-3 mt-3 address-form">
                                    <div>
                                        <label class="dm-sans font-medium text-gray-12 text-sm" for="com_name">{{ __('Company Name (Optional)') }}</label>
                                        <div>
                                            <input id="com_name" name="com_name" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-2 rounded-sm dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2  focus:border-gray-12 dark:focus:border-purple-500 focus:outline-none form-control" maxlength="191" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 address-form">
                                    ...
                                    <div>
                                        <label class="dm-sans font-medium text-gray-12 text-sm" for="email">{{ __('Email Address') }} <span>*</span></label>
                                        <input id="email" name="email" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-2 rounded-sm dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2   focus:border-gray-12 dark:focus:border-purple-500 focus:outline-none form-control required-field" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" value="{{ old('email') }}">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 gap-3 mt-3 address-form">
                                    <div>
                                ...
                                <div class="grid grid-cols-2 gap-3 mt-3 address-form">
                                    <div>
                                        ...
                                        <input id="city" name="city" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-2 rounded-sm dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2 focus:border-gray-12 dark:focus:border-purple-500 focus:outline-none form-control required-field"
                                               required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" maxlength="191" value="{{ old('city') }}">
                                    </div>
                                    <div>
                                        <label class="dm-sans font-medium text-gray-12 text-sm" for="zip">{{ __('Postcode') . ' / ' . __('ZIP') }} <span>*</span></label>
                                        <input id="zip" name="zip" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-2 rounded-sm dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2 focus:border-gray-12 dark:focus:border-purple-500 focus:outline-none form-control positive-int-number required-field"
                                               required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" maxlength="191" value="{{ old('zip') }}">
                                    </div>
                                </div>
                                <div class="grid grid-cols-2 gap-3 mt-3 address-form">
                                    <div>
                                        <label class="dm-sans font-medium text-gray-12 text-sm" for="country">{{ __('Country') }} <span>*</span></label>
                                        <input id="country" name="country" type="country" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-2 rounded-sm dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2 focus:border-gray-12 dark:focus:border-purple-500 focus:outline-none form-control required-field"
                                               required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" maxlength="191" value="{{ old('country') }}">
                                    </div>
                                    <div>
                                        <label class="dm-sans font-medium text-gray-12 text-sm" for="state">{{ __('State') . ' / ' . __('Province') }} <span>*</span></label>
                                        <input id="state" name="state"  type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-2 rounded-sm dark:bg-gray-2 dark:border-gray-0 dark:text-gray-2 focus:border-gray-12 dark:focus:border-purple-500 focus:outline-none form-control required-field"
                                               required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" maxlength="191" value="{{ old('state') }}">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 gap-3 mt-3 address-form">
                                    ...
                                    <div class="flex mt-3p">
                                        ...
                                        <div class="lg:ml-18p ml-2">
                                            <div class="flex"><svg class=" my-18p lg:block hidden" xmlns="http://www.w3.org/2000/svg" width="16" height="18"  viewBox="0 0 16 18" fill="none">
                                                ...
                                                </svg><span class="ml-2 lg:my-18p mr-9 my-3">{{ __('Home') }}</span>
                                            </div>
                                        </div>
                                    </span>
                                            </label>
                                        ...
                                        <div class="lg:ml-18p ml-2">
                                            <div class="flex">
                                                ...
                                                </svg><span class="ml-2 lg:my-18p mr-9 my-3">{{ __('Office') }}</span>
                                            </div>
                                        </div>
                                    </span>
                                            </label>
                        ...
                        <div class="mt-4 w-full address-textarea">
                            <label for="delivery-instructions" class="dm-sans font-medium text-gray-12 text-sm">{{ __('Delivery Instructions (Optional)') }}</label>
                        ...
                        <div class="mt-4 w-full radio-container-payment">
                        ...
                        <div class="rounded bg-white dark:bg-gray-2 w-full border">
                            <div class="w-full bg-orange-200 px-5 py-5 text-gray-12 font-medium dm-sans">
                                ...
                                <div class="flex justify-between mt-3 text-sm border-b pb-3">
                                    ...
                                    <div class='text-right'><span id="cart-subtotal">{{ formatCurrencyAmount($selectedTotal) }}</span>
                                    </div>
                                </div>
                                @if(isActive('Shipping'))
                                    <div class="flex justify-between mt-3">
                                        <div class="text-sm">
                                            {{ __('Shipping') }}</div>
                                        <div class='text-sm text-right'><span id="shipping">{{ formatCurrencyAmount($shipping) }}</span>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if (isActive('Coupon'))
                                    <div class="flex justify-between mt-3">
                                        <div class="text-md text-orange-900 font-bold dark:text-gray-2">
                                            {{ __('Coupon offer') }}
                                        </div>
                                        @php $couponOffer = 0; @endphp
                                        @if (isset($coupon) && !empty($coupon))
                                            @php  $couponOffer = $coupon['calculated_discount']; @endphp
                                        @endif
                                        <div class="text-md text-right font-bold  dark:text-pink-1">
                                            <span
                                ...
                                <div class="flex justify-between mt-3">
                                    ...
                                    <div class='text-sm text-right'><span id="tax">{{ formatCurrencyAmount($tax) }}</span>
                                    </div>
                                </div>
                                <div class="flex justify-between mt-3 border-t">
                                    ...
                                    <div class="text-base mt-2">
                                        <span
                                            id="cart-total">{{ formatNumber(($selectedTotal - $couponOffer) + $tax + $shipping) }}</span>
                                    </div>
                                </div>
                                <button type="submit" class="checkOut process-hover relative flex justify-center text-center px-4 py-4 text-base text-white w-full mt-5 rounded dm-bold font-bold hover:bg-yellow-1 hover:text-gray-12 bg-black" id="makePayment">
                                    <span>{{ __('Make Payment') }}</span>
                                    <svg class="mt-2 ml-2 absolute" width="15" height="10" viewBox="0 0 15 10" fill="none" xmlns="http://www.w3.org/2000/svg">
