    ...
    <div class="bg-white dark:bg-gray-600 p-8 rounded-lg shadow relative hover:shadow flex flex-wrap transition duration-500">
        <section class="">
            <h1 class="text-xl font-semibold border-b pb-2 mb-4 mr-4 text-gray-700 capitalize dark:text-white">
                {{ __('Edit :x', ['x' => __('Address')]) }}
            </h1>
            <form action="{{ route('site.addressUpdate', ['id' => $address->id]) }}" method="post">
                @csrf
                <div class="flex flex-wrap w-full">
                    <div class="w-1/2">
                        <div class="mr-4">
                            <label class="text-dark dark:text-gray-200" for="first_name">{{ __('First Name') }} <span class="text-red-500">*</span></label>
                            <input id="first_name" name="first_name" type="text" value="{{ !empty(old('first_name')) ? old('first_name') : $address->first_name }}"
                    ...
                    <div class="w-1/2">
                        <div class="mr-4">
                            ...
                            <input id="last_name" name="last_name" value="{{ !empty(old('last_name')) ? old('last_name') : $address->last_name }}" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded dark:bg-gray-800 dark:text-white dark:border-gray-600 focus:border-purple-500 dark:focus:border-purple-500 focus:outline-none form-control"
                            required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                    </div>
                    ...
                    <div class="w-1/2 mt-5">
                        <div class="mr-4">
                            ...
                            <input id="city" name="city" type="text" value="{{ !empty(old('city')) ? old('city') : $address->city }}" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded dark:bg-gray-800 dark:text-white dark:border-gray-600 focus:border-purple-500 dark:focus:border-purple-500 focus:outline-none form-control"
                            required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                    </div>
                    ...
                    <div class="w-1/2 mt-5">
                        <div class="mr-4">
                            ...
                            <input id="zip" name="zip" type="text" value="{{ !empty(old('zip')) ? old('zip') : $address->zip }}" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded dark:bg-gray-800 dark:text-white dark:border-gray-600 focus:border-purple-500 dark:focus:border-purple-500 focus:outline-none form-control positive-int-number"
                            required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                    </div>
                    <div class="w-1/2 mt-5">
                    ...
                    <div class="w-1/2 mt-5">
                        <div class="mr-4">
                            ...
                            <input id="state" name="state" value="{{ !empty(old('state')) ? old('state') : $address->state }}" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded dark:bg-gray-800 dark:text-white dark:border-gray-600 focus:border-purple-500 dark:focus:border-purple-500 focus:outline-none form-control"
                            required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                    </div>
                    @if ($address->is_default == 0)
                        <div x-data="{value: {{ $address->is_default == 0 ? '0' : '1' }}, offValue: '0', onValue:'1'}">
