    ...
    <div class="dark:bg-red-1 h-full xl:px-74p px-5 pt-30p xl:pt-14">
        <div class="flex justify-between">
            ...
            <div class="lg:block hidden">
                <a href="" class="flex relative mt-2 arrow-hover font-medium dm-sans text-gray-10 text-base pl-4 rounded-sm">
        ...
        <div class="mt-75p flex justify-between">
            <div>
                <p class="text-gray-10 upperc ase roboto-medium font-medium text-lg">seller</p>
                <p class="dm-sans font-bold text-gray-12 text-28">Xtreme Local Super Shop</p>
                <p class="text-lg roboto-medium font-medium text-gray-10">Order Date: 12 Feb, 2022 at 4:32 pm</p>
            </div>
            <div class="text-right">
                <p class="text-gray-10 upperc ase roboto-medium font-medium text-lg">shipping address</p>
                <p class="dm-sans font-bold text-gray-12 text-28">JOY BUANGARO CUMILLA</p>
                <p class="text-lg roboto-medium font-medium text-gray-10">RT3/A, Kazi Sheikhs & Jonns, Tongi, Gazipur, Dhaka, Bangladesh.</p>
            </div>
        </div>
        <div class="mt-18p w-28 text-center h-10 rounded-sm">
            <p class="dm-sans font-medium text-xl text-green-1 bg-green-2">Paid</p>
        </div>
        <div>
        ...
        <div class="mt-28 p-12 h-245p pl-24 bg-gray-11 flex rounded-sm">
            <div>
                <p class="text-gray-12 mb-2.5 text-sm dm-sans font-medium">Order Placed</p>
                <p class="roboto-medium font-medium text-xs text-gray-10">We have successfully received <br> your orders.</p>
            </div>
            <div class="ml-50p">
            ...
            <table class="w-full  bg-white dark:bg-gray-2 overflow-hidden table-striped dark:border-gray-0">
                <thead>
                    <tr class="text-left bg-gray-11 border border-gray-2 dark:bg-gray-2">
                        <th class="px-6 py-4 text-gray-12 dm-sans font-medium text-xl dark:text-gray-2">{{ __('Items') }}</th>
                                ...
                                <div>
                                    <div class=" items-center flex mb-8 mt-5">
                                        <span class="bg-gray-17 ml-6 h-12 w-12 rounded-sm flex justify-center items-center">
                                            <img class="w-8 h-8" src="{{ asset('public/frontend/assets/img/product/shoe-2.png') }}" alt="" />
                                        </span>
                                        <div class="ml-8">
                                            <a>
                                                <span class="dm-sans font-medium  text-gray-12  pt-2 flex items-center dark:text-gray-2">Zoopie XL Sneakers for Men </span>
                                                <span class="text-sm mt-2 roboto-medium font-medium text-gray-10">Color: White-Clay, Size: 42</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="items-center flex mb-8 mt-5">
                                        ...
                                        <div class="ml-8">
                                            <a>
                                                <span class="dm-sans font-medium  text-gray-12  pt-2 flex items-center dark:text-gray-2"> MAG’s Boom Boom Sneakers from UK</span>
                                                <span class="text-sm mt-2 roboto-medium font-medium text-gray-10">Color: White-Clay, Size: 42</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="flex ml-5">
                                <div class="w-30p h-30p ">
                                    <a class="text-gray-10 justify-center items-center flex bg-gray-2 p-1.5 rounded-sm">
                                        <svg class="" xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16" fill="none">
                ...
                <tfoot>
                    <tr class="focus-within:bg-gray-200 border border-t-0 border-gray-2 overflow-hidden">
                        ...
                        <td class="dark:border-t-gray-2 dark:bg-gray-3 dm-sans font-medium text-gray-12 px-6 py-18p"></td>
                        <td class="dark:border-t-gray-2 dark:bg-gray-3 dm-sans font-medium text-gray-12 px-6 py-18p"></td>
                        er-t-gray-2 text-lg dark:bg-gray-3 dm-sans font-medium text-gray-12 px-6 py-18p">
                        {{ __('Subtotal') }}</td>
