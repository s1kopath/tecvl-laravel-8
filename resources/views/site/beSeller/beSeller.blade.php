...
@section('content')
        ...
        <div class="lg:mx-4 2xl:mx-64 3xl:mr-36 xl:mx-32 mx-5 3xl:ml-92 md:flex md:justify-between md:items-start items-center md:text-left text-center justify-center">
            <div class="xl:pt-135p lg:pt-28 lg:2/5 md:w-1/2 pt-52p text-gray-12">
                ...
                <div class="md:justify-start justify-center flex">
                    <a class="flex process-goto relative lg:mt-30p md:mt-15p mt-30p text-base w-180 h-46p justify-center text-center rounded-sm border border-gray-12 items-center bg-yellow-1 dm-bold font-bold"
            ...
            <div>
                <span class="2xl:block hidden w-851 h-521">
                    <img src="{{ asset('public/frontend/assets/img/be-seller/header_image.svg')}}" alt="">
                </span>
                <span class="md:block 2xl:hidden hidden w-532p mt-14">
                    <img src="{{ asset('public/frontend/assets/img/be-seller/header_image.svg')}}" alt="">
                </span>
                <span class="md:hidden block xs:w-322p xs:h-52 mx-auto md:mt-52p mt-9">
                    <img class="mx-auto" src="{{ asset('public/frontend/assets/img/be-seller/header_image_small.svg')}}"
                        alt="">
                </span>
            </div>
        </div>
    ...
    <div class="xl:mt-33 lg:mt-70p mt-50p mx-4 text-center lg:mx-4 2xl:mx-64 3xl:mx-92">
        ...
        <div class="bg-yellow-1 lg:h-1.5 h-5p lg:w-64 w-216p mx-auto -mt-3">
        </div>
        ...
        <div class="xl:mx-32 mx-5 2xl:mx-0 grid md:grid-cols-3 grid-cols-1 lg:mt-50p mt-8 lg:gap-10 gap-0">
            <div class="hover:bg-gray-20 hover:rounded-lg cursor-pointer transition ease-in-out delay-130">
                <img class="lg:block hidden mx-auto my-50p"
                    src="{{ asset('public/frontend/assets/img/be-seller/low-fees.svg')}}" alt="">
                <img class="lg:hidden block mx-auto mb-6 mt-30p"
                    src="{{ asset('public/frontend/assets/img/be-seller/low-fees-small.svg') }}" alt="">
            ...
            <div class="hover:bg-gray-20 hover:rounded-lg cursor-pointer transition ease-in-out delay-130">
                <img class="lg:block hidden mx-auto my-50p"
                    src="{{ asset('public/frontend/assets/img/be-seller/swift.svg') }}" alt="">
                <img class="lg:hidden block mx-auto mb-6 mt-30p"
                    src="{{ asset('public/frontend/assets/img/be-seller/swift-small.svg') }}" alt="">
            ...
            <div class="hover:bg-gray-20 hover:rounded-lg cursor-pointer transition ease-in-out delay-130">
                <img class="lg:block hidden mx-auto my-50p"
                    src="{{ asset('public/frontend/assets/img/be-seller/support.svg') }}" alt="">
                <img class="lg:hidden block mx-auto mb-6 mt-30p"
                    src="{{ asset('public/frontend/assets/img/be-seller/support-small.svg') }}" alt="">
        ...
        <div class="xl:mt-130p lg:mt-70p mt-54p">
            ...
            <div class="bg-yellow-1 h-1.5 lg:w-120p w-97p mx-auto -mt-3">
            </div>
            ...
            <div class="lg:mx-16 2xl:mx-0 grid lg:grid-cols-2 grid-cols-1 lg:mt-70p mt-35p">
                    ...
                    <div class="roboto-medium font-medium text-gray-10 lg:text-base text-sm ">
                        <div class="flex lg:items-end lg:justify-end items-start text-left lg:text-right justify-start mb-5">
                            <img class="mr-3 mt-1 lg:hidden block"
                                src="{{ asset('public/frontend/assets/img/be-seller/arrow-left.svg') }}" alt="">
                            <p>{{ __('Fill in the sign up form with your personal and shop details') }}</p>
                            <img class="ml-3 mb-1.5 lg:block hidden" src="{{ asset('public/frontend/assets/img/be-seller/arrow-right.svg') }}" alt="">
                        </div>
                        <div class="flex lg:items-end lg:justify-end items-start text-left lg:text-right justify-start mb-5">
                            <img class="mr-3 mt-1 lg:hidden block" src="{{ asset('public/frontend/assets/img/be-seller/arrow-left.svg') }}" alt="">
                ...
                <div class="flex">
                    <div class="mr-60p lg:block hidden items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                                <circle cx="17" cy="17" r="17" fill="#FCCA19" />
                    ...
                    <span class="lg:block hidden h-300p">
                        <img src="{{ asset('public/frontend/assets/img/be-seller/shopping-icon.svg') }}" alt="">
                    </span>
                    <span class="lg:hidden block mx-auto mt-6">
                        <img src="{{ asset('public/frontend/assets/img/be-seller/shopping-small-icon.svg') }}" alt="">
                    </span>
                </div>
                <div class="justify-end flex mr-60p">
                    <span class="w-421-h-376 lg:block hidden">
                        <img src="{{ asset('public/frontend/assets/img/be-seller/shopping-icon-2.svg') }}" alt="">
                    </span>
                </div>
                    ...
                    <div class="lg:text-left lg:mt-0 mt-11 text-center">
                        ...
                        <div class="roboto-medium xxs:px-10 sm:mx-0 font-medium text-gray-10 lg:text-base text-sm">
                            <div class="flex items-start text-left justify-start mb-5">
                                <img class="mr-3 mt-1" src="{{ asset('public/frontend/assets/img/be-seller/arrow-left.svg') }}" alt="">
                ...
                <img class="lg:hidden block mx-auto mt-6"
                    src="{{ asset('public/frontend/assets/img/be-seller/shopping-small-4.svg') }}" alt="">
                <div class="lg:mr-60p mx-auto lg:text-right lg:mt-0 mt-11 text-center">
                    ...
                    <div class="roboto-medium xxs:mx-10 sm:mx-16 lg:mx-0 font-medium text-gray-10 text-base ">
                        <div class="flex lg:items-end lg:justify-end items-start text-left lg:text-right justify-start mb-5">
                            <img class="mr-3 mt-1.5 lg:hidden block" src="{{ asset('public/frontend/assets/img/be-seller/arrow-left.svg') }}" alt="">
                        ...
                        <div class="flex lg:items-end lg:justify-end items-start text-left  lg:text-right justify-start mb-5">
                            ...
                            <img class="ml-3 mb-30p lg:block hidden" src="{{ asset('public/frontend/assets/img/be-seller/arrow-right.svg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="flex">
                    ...
                    <span class="h-312p w-441 lg:block hidden">
                        <img src="{{ asset('public/frontend/assets/img/be-seller/shopping-5.svg') }}" alt="">
                    </span>
                    <span class=" lg:hidden block mx-auto mt-6">
                        <img src="{{ asset('public/frontend/assets/img/be-seller/shopping-6.svg') }}" alt="">
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="3xl:mx-92 2xl:mx-64 xl:mx-32 mx-5  md:flex md:justify-between justify-center">
            <div class="lg:pt-70p pt-54p md:w-1/2 dm-sans text-gray-12">
                <div>
                    ...
                    <div class="bg-yellow-1 h-1.5 text-left lg:w-130p w-28 md:mx-0 mx-auto -mt-3"></div>
                </div>
                ...
                <p class="font-normal lg:text-40 mt-1p text-26 uppercase md:text-left text-center"> <span class="text-orange-2">
                ...
                <div class="xl:flex mt-7 justify-start md:text-left text-center items-center">
                    <a class="flex process-goto relative xl:mr-6 md:mx-0 mx-auto text-base w-44 h-50p justify-center text-center rounded-sm border border-gray-12 items-center bg-yellow-1 dm-bold font-bold"
                    ...
                    <div class="text-gray-12 md:mb-5 xl:mb-0 mb-0 lg:flex md:mt-15p xl:mt-0 mt-6 text-lg dm-sans font-medium">
                        ...
                        <div class="md:px-0 xs:px-20 x:px-12">
                            <a class="underline ml-2p" href="#">{{ __('Login') }}</a>{{ __('to your account.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <span class="xl:block hidden w-543 h-411">
                    <img src="{{ asset('public/frontend/assets/img/be-seller/human.svg') }}" alt="">
                </span>
                <span class="mt-36 lg:block xl:hidden hidden">
                    <img class="w-400p h-312p" src="{{ asset('public/frontend/assets/img/be-seller/human-small.svg') }}" alt="">
                </span>
                <span>
                    <img class="lg:hidden block mx-auto md:mt-32 mt-0 px-5" src="{{ asset('public/frontend/assets/img/be-seller/human-small.svg') }}" alt="">
                </span>
            </div>
        </div>
    </div>
    <div class="lg:mt-130p mt-54p">
        ...
        <div class="bg-yellow-1 h-1.5 lg:w-141p w-116p mx-auto -mt-3">
        </div>
        ...
        <div class="md:w-1/2 xl:w-42%">
                ...
                <div class=" border md:mt-4 mt-0 mx-0 border-gray-21 rounded-lg">
                    <div class="flex lg:mx-7 mx-15p justify-between ">
                        <div class="lg:mt-6 mt-5 flex">
                            <img class="lg:block hidden"src="{{ asset('public/frontend/assets/img/be-seller/seller-human-icon2.svg') }}" alt="">
                            <img class="lg:hidden block"src="{{ asset('public/frontend/assets/img/be-seller/seller-human-small-icon-2.svg') }}" alt="">
                        ...
                        <div class="mt-8">
                            <img class="lg:block hidden" src="{{ asset('public/frontend/assets/img/be-seller/invert-coma.svg') }}">
                            <img class="lg:hidden block" src="{{ asset('public/frontend/assets/img/be-seller/invert-coma-small.svg') }}">
                        </div>
                    </div>
            ...
            <div class="lg:flex md:text-left text-center lg:mt-10 mt-6">
                ...
                <div class="xl:pt-5 md:pt-3 pt-5">
                    <a class="text-gray-12 dm-sans font-medium text-sm md:ml-11 ml-0" href="">{{ __('And many more') }}</a>
                </div>
            </div>
        </div>
        <div class="xl:ml-70p lg:ml-5 ml-0">
            <span>
                <img class="xl:block hidden h-591-w-708" src="{{ asset('public/frontend/assets/img/be-seller/seller-image-1.png') }}" alt="">
            </span>
            <span class="lg:block hidden xl:hidden w-411p">
                <img src="{{ asset('public/frontend/assets/img/be-seller/seller-image-1.png') }}" alt="">
            </span>
            <img class="lg:hidden block h-263p md:px-5 px-0 mx-auto mt-11 w-318p" src="{{ asset('public/frontend/assets/img/be-seller/seller-image-small-1.png.png') }}" alt="">
        </div>
    </div>
        ...
        <div class="xl:mt-130p mt-50p md:mx-5 xl:mx-32 2xl:mx-64 3xl:mx-92 mx-auto ">
            <div class="lg:pt-20 pt-54p ">
                <p class=" dm-bold text-center font-bold text-gray-12 lg:text-lg text-15 uppercase">{{ __('frequestly asked
                    questions') }}</p>
                <div class="bg-yellow-1 h-1.5 lg:w-275p w-225p mx-auto -mt-3">
                </div>
            ...
            <div class="lg:mt-60p mt-9 lg:pb-20 pb-11 text-center">
                ...
                <a class="flex process-goto relative lg:mt-30p mt-18p text-base w-215 mx-auto h-50p justify-center text-center rounded-sm items-center bg-yellow-1 dm-bold font-bold "
        ...
        <div class="3xl:ml-92 2xl:mx-64 xl:ml-32 md:mx-5 md:flex justify-between">
            <div class="mt-70p md:w-2/5 dm-sans text-gray-12">
                <div class="items-center flex justify-center md:justify-start">
                    <img src="{{ asset('public/frontend/assets/img/be-seller/multivendor_logo.svg') }}" alt="">
                </div>
                <p class="dm-bold font-bold lg:mr-32 lg:ml-0 xs:mx-16 x:8 md:text-left text-center lg:text-32 text-2xl mt-18p text-gray-12 uppercase">{{ __('Vendor')}}<span class="text-orange-2">{{ __('Mobile app')}}</span>{{ __('Coming soon..')}}</p>
                ...
                <div class="flex pr-3 md:mx-0 mx-5 lg:mx-0 text-gray-22 items-center relative border border-gray-2 lg:w-354p h-46p mt-3 lg:mt-1.5 bg-white">
                    <input class="border-0 text-sm focus:outline-none w-345p px-15p text-gray-22 font-15 roboto-medium font-medium"
                        placeholder="Email address here" type="text" name="email"/>
                    <button type="submit" class="absolute process-goto right-1 ml-3 border border-gray-2 bg-yellow-1 rounded-sm">
            ...
            <div>
                <img class="w-833-h-744 mt-49p m-285 xl:block hidden" src="{{ asset('public/frontend/assets/img/be-seller/mobile.svg') }}" alt="">
                <span class="md:block mt-40 hidden xl:hidden">
                    <img class="h-411p w-690p -mb-275p" src="{{ asset('public/frontend/assets/img/be-seller/mobile-small.svg') }}" alt="">
                </span>
                <img class="mt-50p x:-mb-28 -mb-32 x:px-5  mx-auto md:hidden block"src="{{ asset('public/frontend/assets/img/be-seller/shopping-small-7.svg') }}" alt="">
            </div>
        </div>
    </div>
@endsection
