...
@section('content')
    <div class="bg-gray-23 lg:bg-cover bg-center">
        <span><img class="3xl:h-full h-36" src="{{ asset('public/frontend/assets/img/be-seller/registration-header-bg.svg') }}" alt=""></span>
    </div>
    <div class="2xl:mx-470p lg:mx-32 md:mx-20 mx-5 mb-70p 3xl:-mt-132p -mt-28 relative border border-gray-2 bg-white rounded-lg">
        ...
        <div class="bg-yellow-1 lg:h-1 h-3p rounded-lg lg:w-93p w-60p mx-auto lg:mt-3.5 mt-3"></div>
        ...
        <form class="lg:mt-8 mt-30p xl:mx-130p lg:mx-70p mx-15p">
            <div class="flex">
                <div class="bg-yellow-1 w-2p lg:h-23p h-5 mt-2p mr-2"> </div>
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 lg:gap-3 gap-0">
                ...
                <div class="lg:mb-3 mb-3.5">
                    ...
                    <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p h-46 proboto-medium pl-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" type="text">
                </div>
            </div>
            ...
            <div class="flex lg:mt-52p mt-9 mb-5">
                <div class="bg-yellow-1 w-2p mt-2p h-23p mr-2"></div>
                ...
                <div class="flex lg:mt-7 mt-18p w-full">
                    ...
                    <div class="lg:block hidden">
                        <div class="flex w-322p">
                            <div class="w-2p h-103p ml-14 mt-49p bg-yellow-1"> </div>
                            <div class="pl-3">
            ...
            <div class="lg:mt-52p mt-10 mb-5 flex">
                <div class="bg-yellow-1 w-2p mt-2p h-23p mr-2">
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="mb-5 relative pass">
                        ...
                        <span class="pass-hide absolute right-1.5 top-3.5 h-4 pl-1.5 pr-3 cursor-pointer">
                            <svg class="" xmlns="http://www.w3.org/2000/svg" width="22" height="19"
            ...
            <div class="flex justify-center items-center mb-8 lg:mt-10 mt-8">
                <a class="flex xl:mr-8 md:mx-0 process-goto relative mx-auto text-base w-52 transition duration-150 ease-in-out h-50p justify-center text-center rounded-sm 2 items-center bg-gray-12 hover:bg-yellow-1 dm-bold font-bold text-white hover:text-gray-12" href="#">{{ __('Register') }} 
