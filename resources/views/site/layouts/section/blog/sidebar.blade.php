            ...
            <div class="relative w-full">
                <form action="{{ route('blog.search') }}" method="get">
                    <div class="h-50p focus:border-gray-12 lg:w-63 w-full rounded border text-decoration-none hover:border-gray-200 border-gray-2">
                        <input class="border-none text-sm h-12 lg:w-56 text-gray-10 roboto-regular font-regular" type="text" name="search" value="{{request()->search}}" placeholder="Search your keyword..">
                    </div>
                ...
                <div class="flex md:justify-between mb-5">
                  <div class="h-20 lg:w-20 w-28">
                    <a href="{{ route('blog.details', ['slug' => $data->slug]) }}">
                        <img class="h-full w-full rounded" src="{{ $data->fileUrl() }}" alt="{{ $data->title }}">
                      </a>
                  </div>
                    <div class="flex justify-center items-center lg:w-44">
