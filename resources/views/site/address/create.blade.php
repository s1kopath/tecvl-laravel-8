    ...
    <div class="dark:bg-red-1 h-full xl:relative xl:px-74p px-5 pt-30p xl:pt-14">
        ...
        <div class="flex justify-between">
            <div class="flex lg:mt-75p mt-10 dm-bold font-bold text-gray-12 lg:text-2xl text-base uppercase">
                <svg class="mr-3 mt-1" xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21"
                    fill="none">
                    <path
                        d="M13.8111 0.06563C13.6306 0.0984421 13.3298 0.176373 13.1451 0.246098C12.3974 0.520903 12.6423 0.30352 7.19391 5.4961C4.26774 8.28106 2.06773 10.4098 1.9732 10.541C1.88727 10.6641 1.77125 10.8691 1.71969 11.0004C1.66383 11.1275 1.4232 12.116 1.18688 13.1947C0.684141 15.4547 0.65836 15.6926 0.856016 16.2258C0.989219 16.5826 1.22125 16.9271 1.48336 17.1486C1.8443 17.4521 2.46734 17.6777 2.9357 17.6777C3.09899 17.6777 6.77711 17.001 7.40875 16.8533C7.52477 16.8246 7.7611 16.7385 7.93727 16.6605C8.25524 16.517 8.34977 16.4309 13.3384 11.673C18.6923 6.5625 18.658 6.59942 18.9287 5.97598C19.122 5.52071 19.1994 5.17207 19.2252 4.63477C19.2595 3.79395 19.0533 3.05977 18.5806 2.39122C18.2756 1.95235 16.9779 0.717777 16.617 0.520903C15.7834 0.06563 14.7693 -0.0984325 13.8111 0.06563ZM14.8381 2.13692C15.2806 2.21485 15.5213 2.37071 16.1959 3.02696C16.8705 3.68321 17.0037 3.88008 17.0896 4.33535C17.1455 4.65118 17.0638 5.08594 16.8877 5.36895C16.8189 5.48379 14.8638 7.39102 11.8861 10.2539L6.99625 14.9502L4.97242 15.2742C3.86383 15.4547 2.9443 15.59 2.9357 15.5818C2.92711 15.5736 3.09898 14.7 3.31813 13.6459L3.71344 11.7223L8.5861 7.0711C12.8529 2.99414 13.4888 2.40352 13.7166 2.29688C14.1162 2.10411 14.417 2.06309 14.8381 2.13692Z"
                        fill="#2C2C2C" />
                    <path
                        d="M1.41481 19.0431C0.757386 19.2728 0.551136 20.1341 1.03239 20.6591C1.10114 20.7371 1.24293 20.8396 1.33746 20.8888L1.51364 20.9791L9.82809 20.9914C19.0836 20.9996 18.4261 21.0201 18.7742 20.7207C18.873 20.6386 18.9847 20.4951 19.0277 20.4049C19.1222 20.208 19.1351 19.8224 19.0492 19.6297C18.959 19.4205 18.7226 19.1908 18.4863 19.0883L18.2715 18.9898L9.91403 18.9939C3.59333 18.9939 1.52223 19.0062 1.41481 19.0431Z"
                        fill="#2C2C2C" />
                </svg>
                <p>{{ __('new address') }}</p>
            </div>
        ...
        <div class="items-center xl:w-1/2 lg:w-ful lg:mt-27p mt-5">
            <div>
                <form onsubmit='return validate();' action="{{ route('site.addressStore') }}" method="post">
                    @csrf
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p">
                        ...
                        <div class="lg:mb-3 mb-3.5">
                            ...
                            <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12"
                                id="last_name" name="last_name" value="{{ old('last_name') }}" type="text">
                        </div>
                    </div>
                    <div class=" lg:mb-3 mb-3.5">
                        <label class=" text-sm dm-sans font-medium capitalize text-gray-12" for="company_name">
                            {{ __('Company Name (Optional)') }} </label>
                        <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12" type="text"
                            name="company_name" id="compnay_name" value="{{ old('company_name') }}">
                    </div>
                    <div class="grid lg:grid-cols-2 grid-cols-1 flex lg:gap-3">
                        ...
                        <div class=" order-first lg:order-none lg:mb-3 mb-3.5">
                            ...
                            <input class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 pl-18p roboto-medium font-medium text-sm text-gray-10 form-control focus:border-gray-12"
                    ...
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p">
                        ...
                        <div class="lg:mb-3 mb-3.5">
                            ...
                            <input id="zip" name="zip" type="text" value="{{ old('zip') }}"
                                class="border-gray-2 rounded-sm w-full lg:h-46p mt-2 lg:mt-1p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12">
                        </div>
                    ...
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p">
                        ...
                        <div class="w-full">
                            ...
                            <input class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12"
                                id="state" name="state" value="{{ old('state') }}" type="text">
                        </div>
                    </div>
                    ...
                    @if ($addresses->count() > 0)
                        ...
                        <div class="form-check mt-0">
                            ...
                            <input name="is_default" value="1" class=" h-4 w-4 border border-gray-2 rounded-sm bg-white text-gray-12 transition duration-200 lg:mt-1 mt-1.5 align-top mr-2 cursor-pointer"type="checkbox" id="flexCheckDefault">
