                ...
                <form class="w-full " action="{{ route('site.addressUpdate', ['id' => $address->id]) }}" method="post">
                    ...
                    <div class="grid grid-cols-2 lg:gap-3  gap-15p  ">
                        ...
                        <div class="lg:mb-3 mb-3.5 ">
                            ...
                            <input class="border-gray-2 rounded-sm w-full mt-1.5 lg:mt-1p lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control focus:border-gray-12"
                                id="last_name" name="last_name" value="{{ !empty(old('last_name')) ? old('last_name') : $address->last_name }}" type="text">
                        </div>
                    </div>
                    <div class="lg:mb-3 mb-3.5 ">
                    ...
                    <div class="grid lg:grid-cols-2 grid-cols-1 flex lg:gap-3">
                        <div class="order-2 lg:order-none lg:mb-3 mb-3.5  ">
                            ...
                            <input class="border-gray-2 rounded-sm mt-1.5 lg:mt-1p w-full lg:h-46p h-10  roboto-medium pl-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12" type="text" id="phone" name="phone"  value="{{ !empty(old('phone')) ? old('phone') : $address->phone }}" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                        <div class="order-first lg:order-none lg:mb-3 mb-3.5 ">
                            ...
                            <input class="border-gray-2 mt-1.5 lg:mt-1p rounded-sm w-full lg:h-46p h-10 pl-18p roboto-medium font-medium text-sm text-gray-10 form-control focus:border-gray-12"
                                type="email" name="email" id="email" value="{{ !empty(old('email')) ? old('email') : $address->email }}"
                    ...
                    <div class="grid grid-cols-2 lg:gap-3  gap-15p">
                        <div class="w-full lg:mb-3 mb-3.5  ">
                            <label class=" text-sm dm-sans font-medium capitalize text-gray-12 require-profile" for="city"> {{ __('City ') }}</label>
                            <input id="city" name="city" type="text" value="{{ !empty(old('city')) ? old('city') : $address->city }}"
                                class="border-gray-2 rounded-sm w-full lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 mt-1.5 lg:mt-1p form-control border focus:border-gray-12"
                                required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                        <div class=" lg:mb-3 mb-3.5 ">
                            <label class=" text-sm dm-sans font-medium capitalize text-gray-12" for="zip">{{ __('Postcode') . ' / ' . __('ZIP') }} </label>
                            <input id="zip" name="zip" type="text"  value="{{ !empty(old('zip')) ? old('zip') : $address->zip }}"
                                class="border-gray-2 mt-2 lg:mt-1p rounded-sm w-full lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control border focus:border-gray-12">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 lg:gap-3 gap-15p   ">
                        <div class="w-full lg:mb-3 mb-3.5  ">
                            <label class=" text-sm dm-sans font-medium capitalize text-gray-12 require-profile"
                                for="country">
                                {{ __('Country ') }}</label>
                            <input class="border-gray-2 rounded-sm w-full lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 mt-1.5 lg:mt-1p form-control border focus:border-gray-12" type="text" id="country"value="{{ !empty(old('country')) ? old('country') : $address->country }}" name="country" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        </div>
                        <div class="w-full lg:mb-3 mb-3.5 ">
                            <label class=" text-sm dm-sans font-medium capitalize text-gray-12" for="state">{{ __('State') . ' / ' . __('Province') }} </label>
                            <input  class="border-gray-2 rounded-sm w-full lg:h-46p h-10 roboto-medium pl-18p font-medium text-sm text-gray-10 form-control mt-1.5 lg:mt-1p border focus:border-gray-12"
                                id="state" name="state"value="{{ !empty(old('state')) ? old('state') : $address->state }}" type="text">
                        </div>
                    </div>
                            ...
                            <div class=" radio-buttons">
                                <label class="custom-radio">
                                    ...
                                    <span
                                        ...
                                        <svg class="mr-13p absolute opacity-0 lg:my-22p mt-15p" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="lg:ml-18p ml-2">
                                            <div class="flex"><svg class=" my-18p lg:block hidden"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        fill="currentColor" />
                                                </svg><span class="ml-2 lg:my-18p mr-9 my-3">{{ __('Home') }}</span></div>
                                        </div>
                                    </span>
                                </label>
                                <label class="custom-radio ml-2">
                                    ...
                                    <span
                                        ...
                                        <div class="lg:ml-18p ml-2">
                                            <div class="flex">
                                                <svg class="    my-18p lg:block hidden" xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <div class="form-check lg:mt-5 mt-6">
                        ...
                        <input name="is_default"
                            class=" h-4 w-4 border border-gray-2 rounded-sm bg-white  text-gray-12 transition duration-200 mt-1 align-top t mr-2 cursor-pointer"
                            type="checkbox" value="1" id="flexCheckDefault">
                        <label class="form-check-label inline-block text-gray-10 text-sm dm-sans font-medium"
                    ...
                    <div class="flex lg:mt-5 mt-6">
                        ...
                        <button type="submit"  class="dm-sans lg:ml-3 ml-0 transition duration-200 items-center cursor-pointer py-3.5 px-6 font-medium text-sm whitespace-nowrap  text-white w-141p h-46p bg-gray-12 hover:bg-yellow-1 hover:text-gray-12 mb-7p rounded">{{ __('Save Address') }}</button>
                    </div>
                </form>
            </div>
        </div>
