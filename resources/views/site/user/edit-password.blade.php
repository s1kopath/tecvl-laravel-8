            ...
            <div class="container mx-auto w-full h-full">
                <div class="max-w-screen-sm mx-auto w-full h-full flex flex-col items-center justify-center">
                    <div class="bg-white dark:bg-gray-form p-5 mt-8 shadow w-full rounded">
                        <h1 class="text-xl font-semibold border-b pb-2 mr-4 text-gray-700 capitalize dark:text-gray-2 dark:border-b-gray-2">
                            {{ __('Change Password') }}
                        </h1>
                        <form action="{{ route('site.userProfileUpdatePassword') }}" method="POST" class="flex flex-col space-y-4" id="password-validate-submit">
                            ...
                            <div class="flex flex-col space-y-2 dark:text-gray-2">
                                ...
                                <input type="password" id="old_password" name="old_password"
                                    ...
                                    required minlength="5" oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-min-length="{{ __(':x should contain at least :x characters.', ['x' => __('Old Password'), 'x' => 5]) }}">
                            </div>
                            <div class="flex flex-col space-y-2 dark:text-gray-2">
                                ...
                                <input type="password" id="new_password" name="new_password"
                                    ...
                                    required minlength="5" oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-min-length="{{ __(':x should contain at least :x characters.', ['x' => __('New Password'), 'x' => 5]) }}">
                            ...
                            <div class="flex flex-col space-y-2 pb-4 dark:text-gray-2">
                                ...
                                <input type="password" id="confirm_password" name="confirm_password"
                                    ...
                                    required minlength="5" oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-min-length="{{ __(':x should contain at least :x characters.', ['x' => __('Confirm Password'), 'x' => 5]) }}">
                            </div>
