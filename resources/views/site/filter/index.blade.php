    ...
    <section class="mx-4 lg:mx-4 xl:mx-32 2xl:mx-64 3xl:mx-92" id="item-filter-container-desktop">
        ...
        <div class="relative mt-6 hidden md:block">
            ...
            <div class="absolute top-0 p-6">
                ...
                <div class="flex text-gray-12 border-gray-800 relative pro-hover border rounded-sm text-xs justify-center p-2 w-32 mt-3 hover:bg-gray-12 hover:text-white cursor-pointer duration-400">
                    <p class="mr-4 font-medium">Shop Now</p>
                    <svg class="mt-5p absolute" width="10" height="7" viewBox="0 0 10 7" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <nav class="text-gray-600 text-sm mt-9" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex text-sm roboto-medium font-medium text-gray-10 bread-hover">
                ...
                @elseif(isset($parentCategory))
                    @foreach($parentCategory as $key => $parent)
                        <li class="flex items-center">
                            @if($key > 0)
                    ...
                    @endforeach
                        <li class="flex items-center">
                            <a href="{{ route('site.categoryItems',$selectedCategorySlug) }}" class="text-gray-12">{{ $selectedCategoryName }}</a>
                        </li>
        ...
        <div class="ajax-load">
         ...
         <div id="loadHtml">
             <input type="hidden" id="selectedCategory" value="{{ $selectedCategory ?? null }}">
         </div>
    </section>
