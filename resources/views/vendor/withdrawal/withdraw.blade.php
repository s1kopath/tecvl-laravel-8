            ...
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <h4 class="f-w-300 mt-2">
                        {{ formatNumber(auth()->user()->wallet()->balance - auth()->user()->wallet()->vendorCommission()) }}
                    </h4>
                </div>
            </div>
                        ...
                        <div class="col-sm-7">
                            ...
                            <form action="{{ route('vendorWithdrawal.money') }}" method="post" class="form-horizontal ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" id="payment_method" name="withdrawal_method_id" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"> >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control positive-float-number" name="amount" id="amount"
                                ...
                                <div class="col-sm-8 px-0">
                                  ...
                                  <a href="{{ route('vendorWithdrawal.index') }}" class="btn btn-info custom-btn-small">{{ __('Cancel') }}</a>
                                </div>
                            </form>
                            @else
