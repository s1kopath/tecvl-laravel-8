...
@section('content')
    <!-- Main content -->
    <div class="col-sm-12 list-container" id="vendor-wallet-withdraw-container">
        <div class="card">
                ...
                <div class="card-block pt-2 p-4">
                    @foreach ($methods as $method)
                        <div class="card col-8 border">
                            <div class="card-header" data-toggle="collapse" data-target="#collapseExample-{{ $method->id }}" aria-expanded="false">
                                <h5>{{ $method->method_name }}</h5>
                            </div>
                            <div class="card-body collapse" id="collapseExample-{{ $method->id }}">
                                ...
                                <form action="{{ route('vendorWithdrawal.setting') }}" method="POST">
                                    ...
                                    @if ($method->method_name == 'Paypal')
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 control-label" for="is_default">{{ __('Default') }}</label>
                                            <div class="col-sm-8">
                                    ...
                                    @if ($method->method_name == 'Bank')
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("Bank Account Holder's name") }}" class="form-control" id="account_holder_name" maxlength="191" name="account_holder_name" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['account_holder_name'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3  control-label require text-left" for="branch_name">{{ __("Branch Name") }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("Branch Name") }}" class="form-control" id="branch_name" name="branch_name" maxlength="50" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['branch_name'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3  control-label require text-left" for="bank_account_number">{{ __("Bank Account Number") . '/IBAN' }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("Bank Account Number") . '/IBAN' }}" class="form-control" id="bank_account_number" name="bank_account_number" maxlength="50" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['bank_account_number'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3  control-label require text-left" for="branch_city">{{ __("Branch City") }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("Branch City") }}" class="form-control" id="branch_city" name="branch_city" maxlength="30" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['branch_city'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3  control-label require text-left" for="swift_code">{{ __("SWIFT Code") }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("SWIFT Code") }}" class="form-control" id="swift_code" name="swift_code" maxlength="15" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['swift_code'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3  control-label require text-left" for="branch_address">{{ __("Branch Address") }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("Branch Address") }}" class="form-control" id="branch_address" name="branch_address" maxlength="191" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['branch_address'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3  control-label require text-left" for="bank_name">{{ __("Bank Name") }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("Bank Name") }}" class="form-control" id="bank_name" name="bank_name" maxlength="60" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['bank_name'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3  control-label require text-left" for="country">{{ __("Country") }}</label>
                                            <div class="col-sm-8">
                                                <input type="text" placeholder="{{ __("Country") }}" class="form-control" id="country" name="country" maxlength="60" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"  value="{{ !empty($param) ? $param['country'] : '' }}">
                                            </div>
                                        </div>
