...
@section('content')
    <!-- Main content -->
    <form class="col-sm-9" action="{{ route('vendor.item.update', $item->id) }}" method="post" id="itemForm" enctype="multipart/form-data">
        @csrf
        <div id="item-edit-container">
            <div id="home" class="card section">
                <div class="card-header">
                    <h5> <a href="{{ route('vendor.items') }}">{{ __('Items') }} </a> >> {{ __('Edit :x', ['x' => __('Item')]) }}</h5>
                </div>
                            ...
                            @if ($rowCount % $numOfCols == 0)
                                ...
                                <div class="form-group row">
                                    ...
                                    @if(optional($attribute->attribute)->type == 'dropdown')
                                        ...
                                        @endphp
                                        <div class="col-sm-4">
                                            <label for="{{ optional($attribute->attribute)->name }}" class="control-label {{ optional($attribute->attribute)->is_required == 1 ? 'require' : '' }}"> {{ optional($attribute->attribute)->name }} </label>
        ...
        <div id="custom-item-info" class="card-border mt-2 card section">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <label for="status" class="control-label mt-3 require">{{ __('Status') }}</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 margin-neg-top-05">
                        <div class="switch d-inline m-r-10">
                            <input type="checkbox" name="is_track_inventory" id="track_inventory" {{ optional($item->itemDetail)->is_track_inventory == 1 ? 'checked' : '' }}>
                ...
                <div id="discount">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" id="discount_from" name="discount_from" class="form-control start_date sl_common_bx" placeholder="{{ __('Discount Start') }}" value="{{ $item->discount_from }}">
                        </div>
                        <div class="col-sm-4">
                            <label for="discount_to" class="control-label" id="discount_to_lbl">{{ __('Discount End') }} </label>
                            <input type="text" id="discount_to" name="discount_to" class="form-control end_date sl_common_bx" placeholder="{{ __('Discount End') }}" value="{{ $item->discount_to }}">
                        </div>
                    </div>
                </div>
            </div>
