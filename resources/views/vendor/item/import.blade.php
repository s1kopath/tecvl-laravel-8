...
<div class="col-sm-12" id="item-import-container">
    <div class="card Recent-Users">
        <div class="card-header">
            <h5><a href="{{ route('vendor.items') }}">{{ __('Items') }}</a> >> {{ __('Import') }}</h5>
        </div>
        <div class="card-body p-0">
            <div class="col-sm-12">
                <div class="card-block pt-2">
                    ...
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#show-brands" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-eye"> &nbsp;</span>{{ __('Brands') }}</a>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#show-categories" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-eye"> &nbsp;</span>{{ __('Categories') }}</a>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#show-attributes" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-eye"> &nbsp;</span>{{ __('Attributes') }}</a>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#show-options" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-eye"> &nbsp;</span>{{ __('Options') }}</a>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#show-shops" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-eye"> &nbsp;</span>{{ __('Shops') }}</a>
                    <hr>
                                    ...
                                    <div class="require-section position-relative">
                                        ...
                                        <table class="table table-bordered mb-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('Your item price will be here.') }}</li>
                                                        <li>{{ __('Example') }}: 99</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('Short description of your item will be here.') }}</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('Long description of your item will be here.') }}</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="optional-section position-relative">
                                        ...
                                        <table  class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('From when the item will be available for users') }}</li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('From when the item will be unavailable for users') }}</li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('This item is sharable or not') }}</li>
                                                        <li>{{ __('Example') }}}}: yes or no</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('If you want to give some discount of your item then you can fill the box.') }}</li>
                                                        <li>{{ __('Note: Suppose your item price is 99 now you can give discount 10 or something') }}</li>
                                                        <li>{{ __('Example') }}: 10</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>{{ __('Discount price') }} = {{ __('item price') }} - {{ __('discount amount') }}</li>
                                                        <li>{{ __('Example') }}: 89</li>
                                                    </ul>
                                                </td>
                                            </tr>
                    ...
                    <form action="{{ route('vendor.item.import') }}" method="post" id="myform1" class="form-horizontal"
                            ...
                            <div class="row">
                                ...
                                <div class="custom-file col-md-8">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control" name="file" accept=".csv">
