...
@section('content')
    <div class="col-sm-12">
        <div class=" card" id="theme-container">
                ...
                <div class="col-3 pr-0" aria-labelledby="navbarDropdown">
                    <div class="card card-info shadow-none">
                        <div class="card-header p-t-20 border-bottom mb-2">
                            <h5><a href="#" id="general-settings">{{ __('Product Setting') }}</a></h5>
                        </div>
                        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <li><a class="nav-link text-left tab-name" id="v-pills-inventory-tab" data-toggle="pill" href="#v-pills-inventory" role="tab" aria-controls="v-pills-inventory" aria-selected="true" data-id = "Inventory">{{ __('Inventory') }}</a></li>
                            <li><a class="nav-link text-left tab-name" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="true" data-id = "Vendor">{{ __('Vendor') }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-9 pl-0">
                    <div class="card card-info shadow-none mb-0">
                        <div class="card-header p-t-20 border-bottom">
                            <h5><a href="#" id="theme-title">{{ __('General') }}</a></h5>
                        </div>

                        <div class="tab-content" id="topNav-v-pills-tabContent">
                            {{-- General --}}
                            <div class="tab-pane fade parent" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab">
                                        ...
                                        <form action="{{ route('product.setting.general') }}" method="post" class="form-horizontal product_setting_form">
                                                        ...
                                                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-9 d-flex">
                                                                    ...
                                                                    <div class="mt-12">
                                                                        <span>{{ __('Coupons can be applied from the cart and checkout pages.') }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <select class="form-control select2" id="measurement_weight" name="measurement_weight">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <select class="form-control select2" id="measurement_dimension" name="measurement_dimension">
                                            ...
                                            <div class="card-footer p-0">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <button type="submit" class="btn btn-primary form-submit custom-btn-small float-right save-button" id="footer-btn">
                                                    ...
                                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                        ...
                                                        <div class="form-group row dependency">
                                                            ...
                                                            <div class="col-9">
                                                                <div class="col-4 pl-0">
                                                                    <input type="number" class="form-control" name="hold_stock" id="hold_stock" min="0" value="{{ isset($setting['hold_stock']) ? $setting['hold_stock'] : 0 }}">
                                                                </div>
                                                                <div class="mt-2">
                                                        ...
                                                        <div class="form-group row dependency">
                                                            ...
                                                            <div class="col-9 d-flex mt-neg-2">
                                                                ...
                                                                <div class="mt-12">
                                                                    <span>{{ __('Hide out of stock items from the catalog') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row radio">
                                                                    <div class="col-sm-12 mb-2">
                                                                        <div class="radio d-inline">
                                                                            ...
                                                                            <label class="cr custom" for="always_show">{{ __('Always show quantity remaining in stock e.g. "12 in stock"') }}</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12 mb-2">
                                                                        <div class="radio d-inline">
                                                                            ...
                                                                            <label class="cr custom" for="sometime_show">{{ __('Only show quantity remaining in stock when low e.g. "Only 2 left in stock"') }}</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <div class="radio d-inline">
                                                                            ...
                                                                            <label class="cr custom" for="never_show">{{ __('Never show quantity remaining in stock') }}</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-tabs">
                                                    <div class="tab-content box-shadow-unset px-0 py-2">
                                                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                            ...
                                                            <div class="form-group row dependency">
                                                                <label for="is_category_based" class="col-sm-3 control-label">{{ __('Category based commission') }}</label>
                                                                <div class="col-sm-1 margin-neg-top-05">
                                                            ...
                                                            <div class="form-group row dependency">
                                                                ...
                                                                <div class="col-9">
                                                                    <div class="col-4 pl-0">
                                                                        <input type="number" min="0" class="form-control" name="amount" id="amount" value="{{ isset($commission['amount']) ? $commission['amount'] : 0 }}">
                                                                    </div>
                                                                    <div class="mt-2">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="show_sold_by" class="col-sm-3 control-label">{{ __('Show sold by') }}</label>
                                                                <div class="col-sm-1 margin-neg-top-05">
                                                                    <input type="hidden" name="show_sold_by" value="0">
                                                                    <div class="switch d-inline m-r-10">
                                                                        <input type="checkbox" name="show_sold_by" id="show_sold_by" value="1" {{ isset($setting['show_sold_by']) && $setting['show_sold_by'] == 1 ? 'checked' : '' }}>
                                                                        <label for="show_sold_by" class="cr"></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
