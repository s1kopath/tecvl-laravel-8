    ...
    <div class="col-sm-12" id="item-view-container">
        <div class="card">
            <div class="card-header">
                <h5> <a href="{{ route('item.index') }}">{{ __('Items') }} </a> >>{{ __('View :x', ['x' => __('Item')]) }}</h5>
            </div>
            <div class="col-sm-12 m-t-20 form-tabs">
                <ul class="nav nav-tabs " id="myTab" role="tablist">
                    ...
                    @endif
                    <li class="nav-item">
                        <a class="nav-link text-uppercase" id="profile-tab" data-toggle="tab" data-rel="" href="#seo" role="tab" aria-controls="seo" aria-selected="false">{{ __('SEO') }}</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="row">
                        <div class="col-sm-12">
                            <form action='{{ route('item.seo') }}' class="form-horizontal" method="POST">
                                @csrf
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 control-label">{{ __('Meta :x', ['x' => __('Title')]) }}</label>
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="{{ __('Title') }}" class="form-control" id="seo_title" name="title" value="{{ $itemSeo->title ?? null }}" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 control-label">{{ __('Meta :x', ['x' => __('Description')]) }}</label>
                                    <div class="col-sm-6">
                                        <textarea class="form-control" id="seo_description" name="description">{{ $itemSeo->description ?? null }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 control-label">{{ __('Slug') }}</label>
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="{{ __('Slug') }}" class="form-control" id="seo_slug" name="slug" value="{{ $itemSeo->slug ?? null }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label">{{ __('Meta :x', ['x' => __('Images')]) }}</label>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="" id="img-container">
                                            ...
                                            <div class="d-flex flex-wrap mt-2">
                                                <div class="position-relative border boder-1 p-1 mr-2 rounded mt-2">
                                                    ...
                                                    <img class="upl-img" class="p-1" src="{{ $itemSeo->fileUrl() }}" alt="">
                                                    <input type="hidden" name="file_id[]" value="{{ $itemSeo->id }}">
                                                    <div class="img-text pl-2">{{ isset($itemSeo->params) && !empty($itemSeo->params['type']) ?  $itemSeo->params['type'] : '' }}</div>
                                                    <small class="img-size pl-2">{{ isset($itemSeo->params) && !empty($itemSeo->params['size']) ?  $itemSeo->params['size'] : '' }} kb</small>
                                                </div>
                                            </div>
                                            @endif
                                        </div>
                  ...
                  <div class="tab-pane fade" id="inventory" role="tabpanel" aria-labelledby="inventory-tab">
                    <div class="row">
                        <div class="col-sm-12">
                            <form action='{{ route('item.related',"inventory") }}' class="form-horizontal" method="POST">
                                @csrf
                                <input type="hidden" value="{{ $item->id }}" name="item_id" id="item_id">
                                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <form action='{{ route('item.related',"option") }}' class="form-horizontal" method="POST">
                                @csrf
                    ...
                    <div class="tab-pane fade" id="related" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row">
                            <div class="col-sm-12">
                                <form action='{{ route('item.related',"relate") }}' class="form-horizontal" method="POST">
                                    @csrf
                    ...
                    <div class="tab-pane fade" id="cross_sale" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row">
                            <div class="col-sm-12">
                                <form action='{{ route('item.related',"cross") }}' class="form-horizontal" method="POST">
                                    @csrf
                                    <div class="col-sm-8 mb-3">
                                        <div class="form-group row mb-0">
                                            <label class="col-md-2 col-form-label">{{ __('Add')  }}&nbsp;&nbsp;<span class="searchItemTh"> {{ __('Item')  }} </span></label>
                    ...
                    <div class="tab-pane fade" id="up_sale" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row">
                            <div class="col-sm-12">
                                <form action='{{ route('item.related',"up") }}' class="form-horizontal" method="POST">
                                    @csrf
                                    <div class="col-sm-8 mb-3">
                                        <div class="form-group row mb-0">
                                            <label class="col-md-2 col-form-label">{{ __('Add')  }}&nbsp;&nbsp;<span class="searchItemTh"> {{ __('Item')  }} </span></label>
