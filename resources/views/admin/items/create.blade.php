    ...
    <div class="col-sm-9" id="item-add-container">
        <div id="home" class="section card">
            <div class="card-header card-head">
                <h5 class="border-blue"> <a href="{{ route('item.index') }}">{{ __('Items') }} </a> >>{{ __('Create :x', ['x' => __('Item')]) }}</h5>
            </div>
            <div class="table-border-style">
                <div class="row form-tabs">
                    <form action="{{ route('item.store') }}" method="post" id="itemForm" class="col-sm-12" enctype="multipart/form-data">
                        @csrf
                        <div class="col-sm-12 p-0 form-edit-con">
                                    ...
                                    <div class="col-sm-12 p-4">
                                            <div class="card-body bg-white">
                                                ...
                                                <div class="form-group row form-h">
                                                    <label class="control-label require pl-3">{{ __('Category') }}</label>
                                                    <div class="col-sm-12">
                                                        <input class="form-control form-width" id="custom-show" autocomplete="off">
                                                        <div class="Content">
