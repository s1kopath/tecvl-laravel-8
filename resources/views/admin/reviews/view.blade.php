            ...
            <div class="card-body mt-2 order-review-section">
                ...
                <div class="row mt-3 pt-4 reviews">
                    ...
                    <div class="col-md-6 col-xl-4 mt-3 mt-md-0">
                        <p>{{ __('Comment') }}</p>
                        <span class="review-comments">{{ $reviews->comments }}</span>
                    </div>
               </div>
                       ...
                       <div class="d-flex align-items-center">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20" fill="none">
                                    <path d="M10.8476 0L13.283 7.49548H21.1642L14.7882 12.1279L17.2236 19.6234L10.8476 14.991L4.47153 19.6234L6.90696 12.1279L0.530918 7.49548H8.41214L10.8476 0Z" fill="#FCCA19"/>
                                </svg>
                            </span>
                            <span class="ml-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20" fill="none">
                            ...
                            <span class="ml-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20" fill="none">
                                    <path d="M11.1523 0L13.5877 7.49548H21.4689L15.0929 12.1279L17.5283 19.6234L11.1523 14.991L4.77621 19.6234L7.21164 12.1279L0.835606 7.49548H8.71682L11.1523 0Z" fill="#C4C4C4"/>
                                </svg>
                            </span>
                            <span class="ml-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20" fill="none">
                            ...
                            <span class="ml-2 rating-count">
                                <span>{{ $reviews->rating }}</span> stars
                            </span>
                       </div>
                    </div>
                    <div class="col-md-6 col-xl-4 mt-3 mt-md-0">
                        ...
                        <div class="d-flex">
                            <div>
                                <img class="img-fluid review-photos" src="{{ asset('public\dist\img\review-item.png') }}" alt="">
                            </div>
                            <div class="ml-3">
                                <img class="img-fluid review-photos"  src="{{ asset('public\dist\img\review-item.png') }}" alt="">
                            </div>
