    ...
    <div class="col-sm-12" id="sms-template-edit-container">
        <div class="card">
            <div class="card-header">
                <h5> <a href="{{ route('smsTemplates.index') }}">{{ __('SMS Templates') }}</a> >>{{ __('Edit :x', ['x' => __('Template')]) }}</h5>
            ...
            <div class="col-sm-12 m-t-20 form-tabs">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <form action='{{ route("smsTemplates.update", ["id" => $template->id])}}' method="post" class="form-horizontal" id="userEdit" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control select2" name="status" id="status">
                                                        <option value="Pending" {{ old('status', $template->status) == 'Pending' ? 'selected' : ''}}>{{ __('Pending') }}</option>
