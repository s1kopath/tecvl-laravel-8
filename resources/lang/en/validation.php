...
return [
    ...
    */
    ...
    'check_quantity' => __('Item Quantity Should Not be Less Than One!'),
    'between'              => [
    ...
    'filled'               => __('The :attribute field is required.'),
    ...
    */
    ...
    'custom' => [
        ...
        'end_date' => [
            'after_or_equal' => __('The :attribute must be greater than or equal to start date.'),
        ],
        'gCaptcha' => [
