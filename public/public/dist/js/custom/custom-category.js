...
$('#categorySubmit').click(function(e) {
    ...
    if ($('#category_id').val() != '' && $('#category_id').val() != lastCatgeoryId) {
        $('#categoryWarning').modal('show');
    } else {
        if ($('#category_id').val() != lastCatgeoryId) {
            changeCategory();
        } else if ($('#category_id').val() == lastCatgeoryId) {
            currentSectionClick = false;
        }
    }
});

$('#confirmChangeCategory').click(function(e) {
    e.preventDefault();
    $('#categoryWarning').modal('hide');
    changeCategory();
});
...
function loadListItem (isPathCall = true)
{
