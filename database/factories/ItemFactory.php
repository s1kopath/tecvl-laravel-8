...
class ItemFactory extends Factory
{
    ...
    return [
        'item_code' => $this->faker->randomDigit(),  
        ...
        'status' => 'Active', 
        'is_virtual' => $this->faker->numberBetween($min = 0, $max = 1), 
        'is_shippable' =>  $this->faker->numberBetween($min = 0, $max = 1), 
        'is_shareable' => $this->faker->numberBetween($min = 0, $max = 1), 
        'favourite_count' =>  $this->faker->numberBetween($min = 0, $max = 1), 
        'wish_count' =>  $this->faker->numberBetween($min = 3, $max = 30),  
        'price' => $price,  
