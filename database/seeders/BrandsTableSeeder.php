    ...
    public function run()
    {
        ...
        \DB::table('brands')->insert(array (
            ...
            array (
                ...
                'vendor_id' => 1,
                'name' => 'Easy Fashion',
                'description' => 'These prime causes EASY’s clicked in the generals as well as fashionable customers. Besides young & fashionable items EASY’s making College & University Students based fashionable products that marketing run only on EASY’s showrooms. Most popular men fashion clothing in Easy fashion ltd Bangladesh. Popular fashion house in Bangladesh',
                'status' => 'Active',
            ),
            26 => 
            array (
